...
$query_Inventory = "SELECT inv_key, inv_category, inv_desc, inv_units_initial, inv_units_current, unit_cost, inv_vendor, last_restock_date, stock_status, updated_by, update_date, rec_deleted FROM pgc_inventory WHERE rec_deleted <> 'Y' ORDER BY inv_category ASC";
...
<title>PGC INVENTORY SELECT </title>
<style type="text/css">
<!--
body,td,th {
...
<table width="1200" height="95%" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#000033">
      ...
      <tr>
            <td height="521" bgcolor="#666666"><table width="95%" height="95%" align="center" cellpadding="4" cellspacing="3" bordercolor="#005B5B" bgcolor="#003648">
                        <tr>
                          <td width="1562" height="26" valign="middle" bgcolor="#005B5B"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td width="30%"><div align="center"><span class="style42">HARDWARE INVENTORY SELECT </span></div></td>
                              <td width="35%"><table width="99%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="52%" class="style54"><div align="center"></div></td>
                                  <td width="5%">&nbsp;</td>
                                  <td width="43%"><div align="center" class="style17"><a href="pgc_squawk_work.php?sq_id=<?php echo $_SESSION['current_sq'] ?>"><img src="Graphics/Cancel copy.png" alt="Cancel" width="130" height="30" border="0" /></a><a href="pgc_squawk_work.php?sq_id=<?php echo $_SESSION['current_sq'] ?>"></a></div></td>
                                </tr>
                              </table></td>
                            </tr>
                          </table></td>
                        ...
                        <tr>
                          <td height="464" align="center" valign="top" bgcolor="#005B5B"><p class="style54 style58">Select Hardware used to remedy  SQUAWK issue</p>
                            <table cellpadding="4" cellspacing="3" bgcolor="#A2B3B3">
                              <tr>
                                <td bgcolor="#35415B" class="style16"><div align="center"><strong><em>SELECT</em></strong></div></td>
                              ...
                              <?php do { ?>
                                <tr>
                                  <td bgcolor="#48597B"><span class="style55"><a href="pgc_inventory_apply.php?inv_key=<?php echo $row_Inventory['inv_key']?>"><?php echo $row_Inventory['inv_key']; ?></a></span></td>
