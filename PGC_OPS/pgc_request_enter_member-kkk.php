...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO pgc_request (member_name, member_id, request_date, request_time, request_type, request_cfig, request_notes) VALUES (%s, %s, %s, %s, %s, %s, %s)",
    ...
    <td height="398" bgcolor="#666666"><table width="900" height="377" align="center" cellpadding="4" cellspacing="3" bordercolor="#005B5B" bgcolor="#005B5B">
        ...
        <tr>
            <td height="277" align="center" valign="top" bgcolor="#4F5359"><form action="<?php echo $editFormAction; ?>" method="post" name="new_flight" id="new_flight">
              <table width="50%" border="0" cellpadding="2" cellspacing="2" bgcolor="#666666">
                <tr>
                  <td width="214" height="30" valign="middle" bgcolor="#6666FF" class="style32"><div align="center"><?php echo $_SESSION['MM_PilotName']; ?></div></td>
                  <td width="214" valign="middle" bgcolor="#6666FF" class="style32"><div align="center"><?php echo $_SESSION['MM_Username']; ?></div></td>
                </tr>
              </table>
              <p>&nbsp;</p>
              <table width="367" align="center" cellpadding="5" cellspacing="2" bgcolor="#666666">
                <tr valign="baseline">
                  <td width="140" height="48" align="right" valign="middle" nowrap bgcolor="#6666FF" class="style25"><div align="left" class="style31">INSTRUCTION DATE: </div></td>
                ...
                <tr valign="middle" bgcolor="#6666FF">
                  <td height="43" align="right" nowrap="nowrap"><div align="left" class="style32"><span class="style31">INSTRUCTION TYPE: </span></div></td>
                  <td><select name="request_type" id="request_type">
                      <option value="BFR">BFR</option>
                      <option value="PGC CURRENCY">PGC CURRENCY</option>
                      <option value="DUO CHECKOUT">DUO CHECKOUT</option>
                      <option value="STUDENT TRN">STUDENT TRN</option>
                    </select>                  </td>
                </tr>
                <tr valign="middle" bgcolor="#6666FF">
                  <td height="49" align="right" nowrap="nowrap"><div align="left" class="style32">REQUEST NOTES: </div></td>
                  <td><input type="text" name="request_notes" value="" size="32" /></td>
                </tr>
                
                <tr valign="baseline">
                  <td height="35" align="right" valign="middle" nowrap bgcolor="#6666FF" class="style25"><div align="left" class="style31">REQUESTED CFIG: </div></td>
