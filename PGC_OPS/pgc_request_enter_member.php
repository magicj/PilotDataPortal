...
mysql_select_db($database_PGC, $PGC);
$query_DutyDates = "SELECT date, Date_format(date,'%W, %M %e') as mydate FROM pgc_field_duty WHERE fd_type <> 'midweek' AND `date` >=CURDATE() AND `date` <= (CURDATE() + Interval 6 Day) ORDER BY `date` ASC LIMIT 3";
