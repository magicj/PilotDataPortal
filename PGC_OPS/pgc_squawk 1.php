...
// 	$to = "support@pgcsoaring.org, support@pgcsoaring.org" ;
	$to = "goritskijack@gmail.com, michaelclittle@gmail.com, support@pgcsoaring.org, klfranz13@comcast.net, " . $_SESSION['MM_Username'] ;
