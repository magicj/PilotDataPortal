...
$query_Recordset1 = "SELECT * FROM pgc_pilot_signoffs WHERE status = 'NG' ORDER BY pilot_name ASC";
...
<table width="800" border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#666666">
  ...
  <tr>
    <td height="476"><table width="92%" height="456" border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="#005B5B" bgcolor="#4F5359">
      <tr>
        <td height="36"><div align="center"><span class="style11">PGC PILOT SIGNOFF LIST - EXPIRED</span> </div></td>
      </tr>
      <tr>
        <td height="373" align="center" valign="top">&nbsp;
          <table border="1" cellpadding="2" bordercolor="#530000" bgcolor="#00005B">
            <tr>
              <td width="140">pilot_name</td>
              <td width="220">type</td>
              <td width="99">date</td>
              <td width="129">instructor</td>
              <td width="118">expires</td>
              <td width="112">status</td>
            </tr>
            <?php do { ?>
              <tr>
                <td><?php echo $row_Recordset1['pilot_name']; ?></td>
