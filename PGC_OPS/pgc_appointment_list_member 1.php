    ...
    <td height="289" bgcolor="#666666"><table width="99%" height="283" align="center" cellpadding="4" cellspacing="3" bordercolor="#005B5B" bgcolor="#005B5B">
        <tr>
          <td width="1126" height="51" bgcolor="#633845"><div align="center" class="style2">
                  <table width="98%" cellpadding="0" cellspacing="0" bgcolor="#633845">
              <tr>
                <td width="15%" height="16" bgcolor="#0042CA" class="style25 style37"><div align="center" class="style38">ENTER CONFIRMED APPOINTMENT</div></td>
                <td width="70%" bgcolor="#4E2C36"><div align="center" class="style36">MEMBER ENTERED CONFIRMED INSTRUCTION APPOINTMENTS (PROTOTYPE) </div></td>
                <td width="15%"><div align="center"><span class="style33">RED = CFIG OFF DUTY</span></div></td>
              </tr>
              <tr>
                <td height="16">&nbsp;</td>
                <td bgcolor="#4E2C36"><div align="center" class="style37">Talk to your  CFIG and CONFIRM your instruction session   before you enter your 'Confirmed' appointment.</div></td>
                <td><div align="right" class="style34">
                  <div align="center"><a href="pgc_request_vacation_view.php" class="style35">DISPLAY CFIG SCHEDULE </a></div>
                </div></td>
              </tr>
              <tr>
                <td height="16">&nbsp;</td>
        ...
        <tr>
          <td height="189" align="center" valign="top" bgcolor="#633845"><table border="0" align="center" cellpadding="1" cellspacing="3" bgcolor="#36373A">
              <tr>
                <td height="19" bgcolor="#35415B" class="style25"><div align="center">EDIT</div></td>
                <td bgcolor="#35415B" class="style25"><div align="center">MEMBER</div></td>
                <td bgcolor="#35415B" class="style25"><div align="center">WT</div></td>
                <td bgcolor="#35415B" class="style25"><div align="center">DATE  </div></td>
                <td bgcolor="#35415B" class="style25"><div align="center">TYPE</div></td>
                <td bgcolor="#35415B" class="style25"><div align="center"> NOTES</div></td>
                <td bgcolor="#35415B" class="style25"><div align="center">CONFIRMED CFIG</div></td>
                <td bgcolor="#35415B" class="style25"><div align="center">ENTERED BY </div></td>
                <td bgcolor="#35415B" class="style25"><div align="center">ENTERED DATE  </div></td>
              </tr>
              <?php do { ?>
                <tr>
							  <?php
			  ...
			  ?>
                  ...
                  <td bgcolor="<?php echo $color; ?>"><div align="left"><?php echo $row_Requests['member_name']; ?></div></td>
                  <td bgcolor="<?php echo $color1; ?>"><?php echo $row_Requests['entry_date']; ?></td>
                </tr>
        ...
        <tr>
          <td height="29" bgcolor="#4F5359" class="style16"><div align="center"><a href="../07_members_only_pw.php" class="style17"></a>
