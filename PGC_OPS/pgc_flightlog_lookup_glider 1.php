...
$query_Flightlog = sprintf("SELECT * FROM pgc_flightsheet WHERE `GLIDER` = %s ORDER BY `Key` DESC", GetSQLValueString($colname_Flightlog, "text"));
...
mysql_select_db($database_PGC, $PGC);
$query_Flightlog = sprintf("SELECT * FROM pgc_flightsheet WHERE `Glider` = %s ORDER by Date DESC", GetSQLValueString($_GET['recordID'], "text"));
        ...
        <td height="481"><table width="100%" height="447" align="center" cellpadding="2" cellspacing="2" bordercolor="#005B5B" bgcolor="#4F5359">
            ...
            <tr>
                <td height="373" valign="top"><table width="99%" align="center" cellpadding="2" cellspacing="2" bgcolor="#666666">
                                ...
                                <?php do { ?>
                                <tr>
                                  <td bgcolor="#FFFFFF" class="style25"><div align="center" class="style32"><?php echo $row_Flightlog['Date']; ?></div></td>
...
-->
            ...
            <tr>
                <td height="28"><div align="center"><strong class="style3"><a href="../Index.php" class="style16">Back to Main Page</a></strong></div></td>
            </tr>
        </table></td>
    </tr>
</table>
