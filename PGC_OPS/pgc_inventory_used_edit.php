...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE pgc_inventory_used SET inv_used_date=%s, inv_used_units=%s, updated_by=%s, update_date=%s, rec_deleted=%s WHERE inv_used_key=%s",
	...
	If ($_GET['rec_deleted'] =  'Y') {
    /* Replace all units for record deletions */
     $NetUnits = $_SESSION['StartUsed'];
	}
 
    If ($_GET['rec_deleted'] = 'N' ) {
     $NetUnits =  $_SESSION['StartUsed'] - $_POST['inv_used_units'];
	}

    $updateSQL = sprintf("UPDATE pgc_inventory SET inv_units_current = inv_units_current + %s WHERE inv_key=%s",
                       GetSQLValueString($NetUnits, "int"),
                       GetSQLValueString($_SESSION['StockID'], "int"));
    mysql_select_db($database_PGC, $PGC);
    $Result1 = mysql_query($updateSQL, $PGC) or die(mysql_error());
...
$_SESSION['StartUsed'] = $row_Recordset1['inv_used_units'];
$_SESSION['StockID'] = $row_Recordset1['inv_key'];
?>
            ...
            <td height="521" bgcolor="#666666"><table width="95%" height="95%" align="center" cellpadding="4" cellspacing="3" bordercolor="#005B5B" bgcolor="#003648">
                        ...
                        <tr>
                          <td height="464" align="center" valign="top" bgcolor="#005B5B"><form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
                            <p>&nbsp;</p>
                            <table width="410" align="center" cellpadding="4" cellspacing="3" bgcolor="#A2B3B3">
                              <tr valign="baseline">
                              ...
                              <tr valign="baseline">
                                <td align="right" nowrap bgcolor="#48597B" class="style17"><div align="left">Date Used</div></td>
					   ...
					   name="anchor2" class="style44" id="anchor2" onclick="cal.select(document.forms['form1'].inv_used_date,'anchor2','yyyy-MM-dd'); return false">Select From Calendar</a></div></td>
                              ...
                              <tr valign="baseline">
                                <td align="right" nowrap bgcolor="#48597B" class="style17"><div align="left">Units Used </div></td>
                                <td bgcolor="#48597B"><div align="left">
                              ...
                              <tr valign="baseline">
                                <td align="right" nowrap="nowrap" bgcolor="#48597B" class="style17"><div align="left">Description</div></td>
                                <td bgcolor="#48597B"><div align="left" class="style56">
                                  <?php echo $row_Recordset1['inv_desc']; ?>
                                </div></td>
                              </tr>
                              <tr valign="baseline">
                                      <td align="right" nowrap="nowrap" bgcolor="#48597B" class="style17"><div align="left">Stock ID</div></td>
                                      <td bgcolor="#48597B" class="style56"><div align="left"><?php echo $row_Recordset1['inv_key']; ?></div></td>
                              </tr>
                              <tr valign="baseline">
                              ...
                              <tr valign="baseline">
                                <td height="24" align="right" valign="middle" nowrap bgcolor="#48597B" class="style17"><div align="left">Delete Record?</div></td>
                                <td valign="middle" bgcolor="#48597B"><div align="left">
                                        <table width="97%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                        <td width="36%"><select name="rec_deleted">
                                                        ...
                                                        <td width="64%"><span class="style57">SET UNITS USED TO 0 BEFORE DELETING - TO REPLACE STOCK.</span></td>
                                                </tr>
                                        </table>
                                </div></td>
                              </tr>
