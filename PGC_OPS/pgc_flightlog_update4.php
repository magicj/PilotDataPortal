...
/*
If ($_POST['Landing'] <> 'xxxxx' ) {
        $emaillog =  "Source IP: " . $_POST['entry_ip'] . "\n" . "Key: " . $_POST['Key'] . "\n" . "Date: " . $_SESSION['$Logdate'] ."\n" . "Glider: " . $_POST['Glider'] ."\n" . "Pilot1 " . $_POST['Pilot1'] ."\n" . "Pilot2 " . $_POST['Pilot2'] ."\n" . "Takeoff: " . $_POST['Takeoff'] . "\n" . "Landing: " .  $_POST['Landing'] ."\n" . "Duration: " .  $row_Flightlog['Time'] ."\n". "Tow Altitude: " . $_POST['Tow_Altitude'] . "\n" . "Tow Plane: " . $_POST['Tow_Plane'] . "\n" . "Tow Pilot: " . $_POST['Tow_Pilot'] . "\n"  ;   
		$webmaster = "kilokilo@comcast.net";
		$to = $webmaster;
		$subject = "PGC Flightlog - Flight: " . $_POST['Key'] . " Updated By: " . $_POST['entry_ip'] ;
...
?>
              ...
              <tr valign="baseline">
                <td colspan="2" align="right" nowrap bgcolor="#CCCCCC" class="style25"><div align="center">
                    <input type="submit" class="style25" value="Update record" >
                </div></td>
                </tr>
              <tr valign="baseline">
                  <td colspan="2" align="right" nowrap bgcolor="#CCCCCC" class="style25"><span class="style17"><?php echo $row_rsMembers['USER_ID']; ?></span></td>
              </tr>
            </table>
