...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1") && ($_POST["sq_member"] <> "") ) {
...
/*	$message = " Equipment: " . $_POST[sq_equipment] . "\n\n Reported By: ". $_SESSION['MM_PilotName'] . "\n\n Date: " . $_POST[sq_date] .  "\n\n Problem Description: " . $_POST[sq_issue];
  ...
  $insertGoTo = "pgc_squawk_admin_entry.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_PGC, $PGC);
$query_Recordset2 = "SELECT NAME FROM pgc_members WHERE NAME <> '' ORDER BY NAME ASC";
...
<table width="900" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#000033">
      ...
      <tr>
            <td height="398" bgcolor="#666666"><table width="900" height="533" align="center" cellpadding="4" cellspacing="3" bordercolor="#005B5B" bgcolor="#005B5B">
                        <tr>
                          <td width="1562" height="23" valign="top" bgcolor="#0A335C"><div align="center"><span class="style42">ADMIN  - SQUAWK  ENTRY</span></div></td>
                        </tr>
                        <tr>
                                <td height="277" align="center" valign="top" bgcolor="#0A335C"><form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                                        <p>&nbsp;</p>
                                        <table width="575" align="center" cellpadding="4" cellspacing="3" bgcolor="#A2B3B3">
                                                
                                                <tr valign="baseline">
                                                  <td width="117" height="33" align="right" valign="middle" nowrap bgcolor="#35415B" class="style35"><div align="left" class="style45">Reported By:</div></td>
                                                  <td width="446" valign="middle" bgcolor="#48597B"><div align="left">
...
?>
                                                ...
                                                <tr valign="baseline">
                                                  <td align="right" valign="middle" nowrap bgcolor="#35415B" class="style35"><div align="left" class="style45">Squawk Date </div></td>
					   ...
					   name="anchor2" class="style44" id="anchor2" onclick="cal.select(document.forms['form1'].sq_date,'anchor2','yyyy-MM-dd'); return false">Select From Calendar</a></div></td>
                                                ...
                                                <tr valign="baseline">
                                                  <td align="right" valign="middle" nowrap bgcolor="#35415B" class="style17"><div align="left" class="style45">Equipment</div></td>
                                                        <td valign="middle" bgcolor="#48597B"><div align="left">
...
?>
                                                ...
                                                <tr valign="baseline">
                                                  <td align="right" valign="middle" nowrap bgcolor="#35415B"><div align="left" class="style35">Problem</div></td>
                                                  <td bgcolor="#48597B"><textarea name="sq_issue" cols="70" rows="10"></textarea></td>
                                                </tr>
                                                <tr valign="baseline">
                                                        <td colspan="2" align="right" nowrap bgcolor="#35415B"><span class="style45"></span>                                                          <div align="left">
                                                          <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                              <td width="41%"><div align="center">
                                                                
																<input type="image" name="submit" value="Submit Squawk" src="Graphics/Save.png" style="border:0;" />
																 
                                                              </div></td>
                                                              <td width="18%">&nbsp;</td>
                                                              <td width="41%"><div align="center"><a href="pgc_squawk_view.php"><img src="Graphics/Cancel copy.png" alt="Cancel" width="130" height="30" border="0" /></a></div></td>
                                                            </tr>
                                                          </table>
                                                        </div></td>
                                                </tr>
