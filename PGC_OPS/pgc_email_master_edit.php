...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE IGNORE pgc_email_master SET email_purpose=%s, email_notes=%s, email_names=%s, email_addresses=%s WHERE email_key=%s",
                       ...
                       GetSQLValueString($_POST['email_key'], "int"));

  mysql_select_db($database_PGC, $PGC);
  $Result1 = mysql_query($updateSQL, $PGC) or die(mysql_error());

  $updateGoTo = "pgc_email_master_list.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['email_key'])) {
  $colname_Recordset1 = $_GET['email_key'];
}
mysql_select_db($database_PGC, $PGC);
$query_Recordset1 = sprintf("SELECT * FROM pgc_email_master WHERE email_key = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<table width="900" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#595E80">
  ...
  <tr>
    <td height="476"><table width="92%" height="456" align="center" cellpadding="2" cellspacing="2" bordercolor="#005B5B" bgcolor="#4F5359">
      <tr>
        <td height="36" bgcolor="#4F5359"><div align="center"><span class="style11">EMAIL MASTER - UPDATE</span></div></td>
      </tr>
      <tr>
        <td height="373" align="center" valign="top" bgcolor="#424A66"><p>This application is used to identify the people who should get e-mails that are created by the system .. or who are listed as club contacts.&nbsp;</p>
              ...
              <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
                    <table align="center">
                          <tr valign="baseline">
                                <td nowrap="nowrap" align="right">Email_key:</td>
                                <td><?php echo $row_Recordset1['email_key']; ?></td>
                          </tr>
                          <tr valign="baseline">
                                <td nowrap="nowrap" align="right">Email_purpose:</td>
                                <td><input name="email_purpose" type="text" value="<?php echo htmlentities($row_Recordset1['email_purpose'], ENT_COMPAT, 'iso-8859-1'); ?>" size="50" maxlength="50" /></td>
                          </tr>
                          <tr valign="baseline">
                                <td nowrap="nowrap" align="right">Email_notes:</td>
                                <td><textarea name="email_notes" cols="50" rows="4"><?php echo htmlentities($row_Recordset1['email_notes'], ENT_COMPAT, 'iso-8859-1'); ?></textarea></td>
                          </tr>
                          <tr valign="baseline">
                                <td nowrap="nowrap" align="right">Email_names:</td>
                                <td><textarea name="email_names" cols="50" rows="4"><?php echo htmlentities($row_Recordset1['email_names'], ENT_COMPAT, 'iso-8859-1'); ?></textarea></td>
                          </tr>
                          <tr valign="baseline">
                                <td nowrap="nowrap" align="right">Email_addresses:</td>
                                <td><textarea name="email_addresses" cols="50" rows="6"><?php echo htmlentities($row_Recordset1['email_addresses'], ENT_COMPAT, 'iso-8859-1'); ?></textarea></td>
                          </tr>
                          <tr valign="baseline">
                    ...
                    <input type="hidden" name="email_key" value="<?php echo $row_Recordset1['email_key']; ?>" />
              </form>
              <p>&nbsp;</p></td>
      </tr>
      <tr>
