...
$Recordset1 = mysql_query($query_Recordset1, $PGC) or die(mysql_error());
 ...
 mysql_select_db($database_PGC, $PGC);
$query_rsFieldDuty = "SELECT date, date_format(date,'%m/%d/%y') as mydate, date_format(date,'%W') as daydate, fm, fm_email, fm_count, afm_count, afm1, afm1_email, afm2, afm2_email, afm3, afm3_email, cfig, cfig_email, tp1, tp2, `session` FROM pgc_field_duty WHERE fd_type <> 'midweek' AND date >= curdate() ORDER BY `date` ASC";
                ...
                <tr>
                    <td bgcolor="#274987"><div align="center">
                          <table width="99%" cellspacing="0" cellpadding="0">
                                <tr>
                                      <td width="32%"><table width="57%" cellspacing="0" cellpadding="0">
                                            <tr>
                                                  <td align="center" bgcolor="#233C56"><a href="pgc_field_duty_list_only.php" class="BlackButton"> CURRENT DUTY SCHEDULE</a></td>
                                            </tr>
                                      </table></td>
                                      <td width="37%" align="center"><span class="style24">WEEKEND DUTY SCHEDULE - CURRENT VIEW</span></td>
                                      <td width="31%" align="right"><table width="56%" border="0" cellpadding="1" cellspacing="0">
                                            <tr>
      ...
      <tr>
        <td height="106" bgcolor="#1B315A"><div align="center" class="style20">
              <table width="95%" cellspacing="0" cellpadding="0">
                    <tr>
                          <td width="29%" align="center"><a href="mailto:support@pgcsoaring.org?Subject=Field Duty Schedule"><img src="../images/Buttons/fdManagerEmail copy.jpg" width="227" height="62" alt="FDmanager" /></a></td>
              ...
              <table width="600" cellspacing="0" cellpadding="0">
                    <tr>
                          ...
                          <td width="79">&nbsp;</td>
                          <td width="255" align="center"><a href="pgc_field_duty_member_select_sessions.php" class="style16"><img src="../images/Buttons/FD Date Selector.jpg" alt="" width="172" height="24" /></a></td>
                    </tr>
              </table>
        </div></td>
      </tr>
