...
$query_Recordset1 = "SELECT * FROM pgc_pilot_signoffs A, pgc_members B WHERE (A.status = 'Expired-A' OR A.status = 'Expired-B') AND (A.pilot_name = B.NAME) AND (B.active = 'YES') ORDER BY A.signoff_type ASC, A.status ASC";
      ...
      <tr>
        <td height="36" bgcolor="#59111E"><div align="center">
              <table width="98%" cellspacing="1" cellpadding="1">
                    <tr>
                          <td width="18%" align="center" bgcolor="#6C0000" class="style14"><a href="pgc_expired_critical_xls.php" class="style14"><span class="style121">EXCEL REPORT</span></a></td>
                          <td width="66%" align="center"><span class="style11">EXPIRED SIGNOFFS -  NOFLY AND CRITICAL - TYPE SORT</span></td>
                          <td width="16%" align="center" bgcolor="#6C0000"><strong class="style11"><a href="../PGC_OPS/pgc_portal_menu.php" class="style16"><span class="style12">BACK TO MAIN</span></a></strong></td>
                    </tr>
        </table>
        </div></td>
      </tr>
