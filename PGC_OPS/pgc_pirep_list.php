...
mysql_select_db($database_PGC, $PGC);
$query_Recordset1 = "SELECT pirep_key, date_entered, id_entered, id_name, pirep_date, dayname(pirep_date) as pday, pirep_desc, rec_deleted FROM pgc_pirep WHERE rec_deleted <> 'Y' ORDER BY pirep_key DESC";
                                                      ...
                                                      <td height="16" valign="top"><div align="center">
                                                            <table width="99%" cellspacing="2" cellpadding="0">
                                                                  <tr>
                                                                        ...
                                                                        <td width="76%" align="center" bgcolor="#475067" class="style37">PGC PIREPS Plus</td>
                                ...
                                <td height="600" align="center" valign="top" bgcolor="#09294A">&nbsp;
                                      <form id="form1" name="form1" method="post" action="">
                                            <table width="95%" border="0" align="center" cellpadding="3" cellspacing="1" class="PirepPLusTable">
                                                  ...
                                                  <?php do { ?>
                                                        <tr>
                                                              <td height="42" align="center" valign="middle" bgcolor="#002F5E"><a href="pgc_pirep_edit.php?pirep_key=<?php echo  $row_Recordset1['pirep_key']; ?>"><?php echo $row_Recordset1['pirep_key']; ?></a></td>
                                                              ...
                                                              <td align="left" valign="top" bgcolor="#002F5E"><?php echo $row_Recordset1['pirep_desc']; ?></td>
                                                      </tr>
