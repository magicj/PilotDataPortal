...
$query_rsGliders = "SELECT Glider, Count(Glider), Sum(`Time`) FROM pgc_flightsheet WHERE (Pilot1 <> '' OR Pilot2 <> '') AND Glider <> '' GROUP BY Glider";
...
mysql_select_db($database_PGC, $PGC);
$query_rsTowpilot = "SELECT `Tow Pilot`, Count(`Tow Pilot`),Sum(`Tow Altitude`)  FROM pgc_flightsheet WHERE (Pilot1 <> '' OR Pilot2 <> '') AND Glider <> '' GROUP BY `Tow Pilot`  ";
...
mysql_select_db($database_PGC, $PGC);
$query_rsGLIDERGrandTot = "SELECT Count(Glider), Sum(`Time`) FROM pgc_flightsheet WHERE (Pilot1 <> '' OR Pilot2 <> '') AND Glider <> '' ";
...
mysql_select_db($database_PGC, $PGC);
$query_rsTowPilotTotal = "SELECT  Count(`Tow Pilot`),Sum(`Tow Altitude`) FROM pgc_flightsheet WHERE (Pilot1 <> '' OR Pilot2 <> '') AND Glider <> '' ";
...
mysql_select_db($database_PGC, $PGC);
$query_rsMembers = "SELECT Pilot1, Count(Glider), Sum(`Time`) FROM pgc_flightsheet WHERE (Pilot1 <> '' OR Pilot2 <> '') AND Glider <> '' GROUP BY Pilot1";
                    ...
                    <tr>
                        <td height="100" valign="top">&nbsp;
                            <table width="600" border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="#7C7C8F">
                                ...
                                <?php do { ?>
                                    <tr>
                                        <td bgcolor="#516375"><div align="center" class="style37"><strong><a href="pgc_flightlog_lookup_cfig.php?recordID=<?php echo $row_rs_instructors['Pilot2']; ?>"><?php echo $row_rs_instructors['Pilot2']; ?></div></td>
                    ...
                    <tr>
                        <td height="99">&nbsp;
                            <table width="600" border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="#7C7C8F">
                                ...
                                <?php do { ?>
                                    <tr>
                                        <td bgcolor="#516375"><div align="center" class="style37"><?php echo $row_rsTowpilot['Tow Pilot']; ?></div></td>
