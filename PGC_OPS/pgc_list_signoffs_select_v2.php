    ...
    <td height="515"><table width="92%" height="527" align="center" cellpadding="2" cellspacing="2" bordercolor="#005B5B" bgcolor="#464762">
      <tr>
        <td height="36" bgcolor="#4F5359"><div align="center">
              <table width="98%" cellspacing="1" cellpadding="1">
                    <tr>
                          <td width="29%">&nbsp;</td>
                          <td width="43%" align="center"><span class="style11">LIST / MODIFY  PILOT SIGNOFFS </span>(v2)</td>
                          <td width="28%" align="center"><a href="pgc_enter_pilot_signoff_link.php"><img src="../images/Buttons/NewSignoff.jpg" width="162" height="26" /></a></td>
                    </tr>
              </table>
        </div></td>
      </tr>
      ...
      <tr>
        <td height="418" align="center" valign="top" bgcolor="#424A66"><table width="786" cellpadding="2" cellspacing="2" bgcolor="#47567A">
          ...
          <p>&nbsp;</p>
          <form id="form1" name="form1" method="get" action="pgc_list_signoffs_select_v2.php">
            <label>
