...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  ...
  $insertGoTo = "pgc_class_edit_list.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
                                          <table align="center" cellpadding="4" cellspacing="3" bgcolor="#A2B3B3">
                                                  <tr valign="baseline">
                                                          ...
                                                          <td valign="middle" bgcolor="#35415B"><div align="left">
                                                            <input type="text" name="member_name" value="" size="32">
                                                          </div></td>
                                                  </tr>
                                                  <tr valign="baseline">
                                                          <td align="right" valign="middle" nowrap bgcolor="#35415B" class="style50"><div align="left" class="style16">
                                                    ...
                                                    <td valign="middle" bgcolor="#35415B"><div align="left">
                                                      <input name="event_date" type="text" size="10" maxlength="10">
                                                            <a href="#"
					   name="anchor2" class="style44" id="anchor2" onclick="cal.select(document.forms['form2'].event_date,'anchor2','yyyy-MM-dd'); return false">Select From Calendar</a></div></td>
                                                  </tr>
                                                  <tr valign="baseline">
                                                          <td align="right" valign="middle" nowrap bgcolor="#35415B" class="style50"><div align="left" class="style16">
                                                          ...
                                                          <td valign="middle" bgcolor="#35415B"><div align="left">
                                                            <select name="event_name" id="event_name">
                                                              <option value="FIRST SOLO - A BADGE" selected="selected">FIRST SOLO - A BADGE</option>
                                                              <option value="B BADGE">B BADGE</option>
                                                              <option value="C BADGE">C BADGE</option>
                                                  ...
                                                  <tr valign="baseline">
                                                          ...
                                                          <td valign="middle" bgcolor="#35415B"><div align="left">
                                                            <input type="text" name="primary_instructor" value="" size="32">
                                                          </div></td>
                                                  </tr>
                                                  <tr valign="baseline">
                                                          ...
                                                          <td valign="middle" bgcolor="#35415B"><div align="left">
                                                            <textarea name="event_notes" cols="50" rows="5" id="event_notes"></textarea>
                                                          </div></td>
                                                  </tr>
