...
<table width="900" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#000033">
  ...
  <tr>
    <td height="440" bgcolor="#666666"><table width="900" height="565" align="center" cellpadding="4" cellspacing="3" bordercolor="#005B5B" bgcolor="#005B5B">
        <tr>
            <td width="1562" height="56" bgcolor="#4F5359"><div align="center" class="style2">
                <table width="60%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td><div align="center">PGC MEMBER - INSTRUCTION REQUEST</div></td>
                    </tr>
                    <tr>
        ...
        <tr>
            <td height="465" align="center" valign="top" bgcolor="#4F5359"><form action="<?php echo $editFormAction; ?>" method="post" name="new_flight" id="new_flight">
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              <table align="center">
                <tr valign="baseline">
                  <td nowrap align="right">Request_date:</td>
                  <td><input type="text" name="date1" size="10" value="<?php echo "$date1" ?>" />
                    <a href="#" onclick="cal.select(document.forms['new_flight'].date1,'anchor2','yyyy-MM-dd'); return false;"
					   name="anchor2" id="anchor2">select</a></td>
                  <td></div>			      </td>
                </tr>
                <tr valign="baseline">
                  <td nowrap align="right">Request_time:</td>
                  <td>
				  
				              <select name="request_time" id="request_time">
                ...
                <tr valign="baseline">
                  <td nowrap align="right">Request_type:</td>
                  <td>
                ...
                <tr valign="baseline">
                  <td nowrap align="right">Request_cfig:</td>
...
?>
                ...
                <tr valign="baseline">
                  <td nowrap align="right">Request_notes:</td>
