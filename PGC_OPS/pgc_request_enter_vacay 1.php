...
$Vacation = mysql_query($query_Vacation, $PGC) or die(mysql_error());
$row_Vacation = mysql_fetch_assoc($Vacation);
$totalRows_Vacation = mysql_num_rows($Vacation);
