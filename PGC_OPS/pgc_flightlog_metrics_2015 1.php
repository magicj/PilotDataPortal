...
$query_FlightsCurrent = "SELECT '2015' ,Count(Glider), Sum(`Time`), COUNT(distinct `Date`) FROM pgc_flightsheet WHERE (Pilot1 <> '' OR Pilot2 <> '') AND Glider <> ''";
...
$query_FlightsCurrentW = "SELECT '2015W' ,Count(Glider), Sum(`Time`)FROM pgc_flightsheet WHERE (Pilot1 <> '' OR Pilot2 <> '') AND Glider <> '' AND `Tow Pilot` = 'PGC Winch'";
...
$query_FlightsCurrentT = "SELECT '2015T' ,Count(Glider)FROM pgc_flightsheet WHERE (Pilot1 <> '' OR Pilot2 <> '') AND Glider <> '' AND Flight_Type = 'TRN'";
...
mysql_select_db($database_PGC, $PGC);
$query_rsAOFGrandTot = "SELECT Count(Glider), Sum(`Time`) FROM " . $pgc_table . " WHERE (Pilot1 <> '' OR Pilot2 <> '') AND Glider <> '' AND flight_type = 'AOF' ";
                        ...
                        <td height="389" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#2F334F">
                                        ...
                                        <tr>
                                              <td height="256" valign="top"><table width="616" border="0" align="center" cellpadding="2" cellspacing="2">
                                                    ...
                                                    <?php do { ?>
                                                                <tr>
                                                                      <td align="center" bgcolor="#6B5A67" class="BoldMetrics">2015</td>
                                                          ...
                                                          <td align="center" bgcolor="#6B5A67" class="BoldMetrics"><?php echo $row_Flights2014['Count(Glider)']; ?></td>
                                                          <td align="center" bgcolor="#6B5A67" class="BoldMetrics"><?php echo $row_Flights2014T['Count(Glider)']; ?></td>
                                                          <td align="center" bgcolor="#6B5A67" class="BoldMetrics"><?php echo $row_Flights2014W['Count(Glider)']; ?></td>
                                                          <td align="center" bgcolor="#6B5A67" class="BoldMetrics"><?php echo $row_Flights2014['Sum(`Time`)']; ?></td>
                                                          <td align="center" bgcolor="#6B5A67" class="BoldMetrics"><?php echo $row_Flights2014['COUNT(distinct `Date`)']; ?></td>
                                                          <td align="center" bgcolor="#6B5A67" class="BoldMetrics"><?php echo $Flights2014Avg; ?></td>
                                                                </tr>
                                                    <tr>
                                        ...
                                        <tr>
                                              <td height="64" valign="top"><table width="600" border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="#7C7C8F">
                                                    <?php do { ?>
                                                    <tr>
                                                          <td width="250" bgcolor="#6B5A67"><div align="center"><strong><span class="style43"><a href="pgc_flightlog_lookup_AOF.php">AOF FLIGHTS</a></span></strong></div></td>
                                                          <td width="150" bgcolor="#6B5A67"><div align="center"><strong><?php echo $row_rsAOFGrandTot['Count(Glider)']; ?></strong></div>
                                                                <div align="center"></div></td>
                                                          <td bgcolor="#6B5A67"><div align="center"><strong><?php echo $row_rsAOFGrandTot['Sum(`Time`)']; ?></strong></div></td>
                                                    </tr>
