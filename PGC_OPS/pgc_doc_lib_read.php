...
mysql_select_db($database_PGC, $PGC);
$query_Recordset1 = "SELECT doc_file_name, doc_display_name, doc_category, doc_sub_category, doc_source, date_format(doc_posted,'%M %e, %Y') as docdate, date_posted, doc_modified_id, doc_path, doc_upload_link, combo_key FROM pgc_doc_lib_list WHERE doc_display = 'YES' ORDER BY doc_category, doc_sub_category, doc_display_name";
...
mysql_select_db($database_PGC, $PGC);
$query_Recordset1 = sprintf("SELECT doc_file_name, doc_display_name, doc_category, doc_sub_category, doc_source, doc_posted, date_posted, doc_modified_id, doc_reader, doc_display, doc_path, doc_upload_link, combo_key FROM pgc_doc_lib_list WHERE combo_key = %s AND doc_display = 'YES' ORDER BY doc_category, doc_sub_category, doc_display_name", GetSQLValueString($colname_Recordset1, "text"));
$query_limit_Recordset1 = sprintf("%s LIMIT %d, %d", $query_Recordset1, $startRow_Recordset1, $maxRows_Recordset1);
$Recordset1 = mysql_query($query_limit_Recordset1, $PGC) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
...
mysql_select_db($database_PGC, $PGC);
$query_Recordset2 = "SELECT * FROM pgc_doc_lib_list WHERE doc_display = 'YES' ORDER BY combo_key ASC";
...
<table width="1200" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#666666">
    <tr>
      <td align="center" bgcolor="#1D3974"><p class="JobBanner">MEMBER VIEW - PGC DOCUMENT LIBRARY - PROTOTYPE</p></td>
  </tr>
    <tr>
              ...
              <td height="373" colspan="5" align="center" valign="top"><table width="99%" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="48%" align="left"><label for="select"></label>
                      <form id="form1" name="form1" method="get" action="pgc_doc_lib_read.php">
...
?>
                ...
                <?php do { ?>
                  ...
                  <tr>
                    ...
                    <td width="247" bgcolor="#004879"><?php echo $row_Recordset1['doc_display_name']; ?></a></td>
                    <td width="216" align="center" bgcolor="#004879"><?php echo $row_Recordset1['doc_category']; ?></td>
                    <td width="204" align="center" bgcolor="#004879"><?php echo $row_Recordset1['doc_sub_category']; ?></td>
