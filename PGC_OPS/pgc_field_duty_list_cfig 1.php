...
$query_rsFieldDuty = "SELECT date, date_format(date,'%m/%d/%y') as mydate, cfig, tp1, tp2, `session` FROM pgc_field_duty ORDER BY `date` ASC";
    ...
    <td height="429"><table width="98%" height="638" border="0" align="center" cellpadding="5" cellspacing="2" bordercolor="#005B5B" bgcolor="#383A52">
      <tr>
        <td height="25" bgcolor="#545E78"><div align="center">
            <p class="style11">CFIG / TOW PILOT  DUTY  ASSIGNMENTS</p>
        ...
        <td height="570" align="center" valign="top" bgcolor="#666666"><form id="form1" name="form1" method="post" action="">
            ...
            <table width="95%" border="0" cellpadding="2" cellspacing="2" bgcolor="#666666">
                <tr>
                    ...
                    <td bgcolor="#3D4461"><div align="center" class="style351">CFIG</div></td>
                ...
                <?php do { ?>
                    <tr>
                        <td bgcolor="#3D4461"><div align="center"><a href="pgc_field_duty_update_cfig.php?dutydate=<?php echo $row_rsFieldDuty['date'] ; ?>"><?php echo $row_rsFieldDuty['mydate']; ?></a></div></td>
                        <td bgcolor="#3D4461"><div align="center"><?php echo $row_rsFieldDuty['cfig']; ?></div></td>
      ...
      <tr>
        <td height="33"><div align="center"><strong class="style11"><a href="pgc_portal_menu.php" class="style20">BACK TO PDP MAINTENANCE MENU</a></strong></div></td>
      </tr>
    </table></td>
  </tr>
</table>
