...
$totalRows_session_control = mysql_num_rows($session_control);$colname_session_control = "-1";
...
$session_control = mysql_query($query_session_control, $PGC) or die(mysql_error());
$row_session_control = mysql_fetch_assoc($session_control);
$totalRows_session_control = mysql_num_rows($session_control);
?>
...
<?php
mysql_free_result($session_control);
?>
