...
<body>
<table width="1050" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#000033">
  <tr>
        ...
        <tr>
          <td width="1126" height="51" bgcolor="#633845"><div align="center" class="style2">
            <table width="98%" cellpadding="0" cellspacing="0" bgcolor="#633845">
              <tr>
                <td width="15%" height="16" bgcolor="#0042CA" class="style25 style37"><div align="center" class="style38"><a href="pgc_request_enter_member.php">ENTER TRAINING REQUEST</a> </div></td>
                <td width="70%"><div align="center" class="style36">MEMBER ENTER /    MODIFY  REQUESTS</div></td>
                <td width="15%"><div align="center"><span class="style33">RED = CFIG OFF DUTY</span></div></td>
              </tr>
              <tr>
                <td height="16">&nbsp;</td>
                <td><div align="center">You can only: 1/ Edit requests you entered ... and 2/ Edit requests that do not have a CFIG assigned</div></td>
              ...
              <tr>
                <td height="16">&nbsp;</td>
                <td><div align="center">Contact the Instruction Coordinator or the assigned CFIG to modify a request with an Assigned CFIG.</div></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td height="16">&nbsp;</td>
                <td><div class="warning" align="center">Students are required to be at the field no later than 8 AM on the morning of instruction.</div></td>
                <td>&nbsp;</td>
              </tr>
            </table>
          </div></td>
