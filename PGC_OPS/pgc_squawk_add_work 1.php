...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO pgc_squawk_work (sq_key, work_date, worker, work_hours, work_desc, entered_by, rec_deleted) VALUES (%s, %s, %s, %s, %s, %s, %s)",
            ...
            <td height="521" bgcolor="#666666"><table width="95%" height="95%" align="center" cellpadding="4" cellspacing="3" bordercolor="#005B5B" bgcolor="#003648">
                        <tr>
                          <td width="1562" height="26" valign="middle" bgcolor="#005B5B"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="35%">&nbsp;</td>
                              <td width="30%"><div align="center"><span class="style42">SQUAWK ADD WORK or STATUS </span></div></td>
                        ...
                        <tr>
                          <td height="464" align="center" valign="top" bgcolor="#005B5B"><table width="95%" cellpadding="4" cellspacing="3" bgcolor="#A2B3B3">
                            <tr>
                              <td width="80" bgcolor="#35415B"><em><strong>SQUAWK ID </strong></em></td>
					   ...
					   name="anchor2" class="style44" id="anchor2" onclick="cal.select(document.forms['form1'].work_date,'anchor2','yyyy-MM-dd'); return false">Select From Calendar</a></div></td>
                                ...
                                <tr valign="baseline">
                                  <td align="right" valign="middle" nowrap bgcolor="#35415B"><div align="left" class="style55">WORKER(S)</div></td>
                                  <td valign="middle" bgcolor="#48597B"><div align="left">
                                    <textarea name="worker" cols="30" rows="2"></textarea>
                                  </div></td>
                                </tr>
                                <tr valign="baseline">
                                      ...
                                      <tr>
                                        <td width="36%"><div align="center">
                                         <!-- <input name="submit" type="submit" value="SAVE" />-->
										  <input type="image" name="submit" value="SAVE" src="Graphics/Save.png" style="border:0;" />
                                        </div></td>
                                        <td width="29%">&nbsp;</td>
                                        <td width="35%" class="style17"><div align="center"><a href="pgc_squawk_work.php?sq_id=<?php echo $_SESSION['current_sq'] ?>"><img src="Graphics/Cancel copy.png" alt="Cancel" width="130" height="30" border="0" /></a><a href=pgc_squawk_work.php?sq_id=<?php echo $_SESSION['current_sq'] ?>></a></div></td>
                                      </tr>
                                    </table>
                                  </div></td>
                                </tr>
