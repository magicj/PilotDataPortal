...
<table width="900" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#595E80">
  ...
  <tr>
    <td height="481" bgcolor="#3C3E6F"><table width="96%" height="447" align="center" cellpadding="2" cellspacing="2" bordercolor="#005B5B" bgcolor="#4F5359">
      ...
      <tr>
        <td height="373" bgcolor="#424A66"><form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
          <table width="456" height="189" align="center" cellpadding="2" cellspacing="3">
            <tr valign="baseline">
              ...
              <td width="248" valign="middle" bgcolor="#0F4E55"><select name="pilot_name">
                          <?php
do {  
?><option value="<?php echo $row_rsPgcPilots['pilot_name']?>"<?php if (!(strcmp($row_rsPgcPilots['pilot_name'], $_SESSION[last_pilot]))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsPgcPilots['pilot_name']?></option>
                  <?php
              ...
              <td height="61" colspan="2" align="right" valign="middle" nowrap="nowrap" bgcolor="#0F4E55"><div align="center">
                      <table width="98%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                      ...
                                      <td width="49%"> <div align="center" class="style44"><strong><a href="pgc_portal_menu.php">CANCEL INSERT</a> </strong></div></td>
                              </tr>
                      </table>
              </div></td>
              </tr>
