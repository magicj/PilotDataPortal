...
$query_Recordset1 = "SELECT * FROM pgc_pilot_signoffs ORDER BY pilot_name ASC";
...
<title>PGC Data Portal - Pilot Signoff List</title>
<style type="text/css">
<!--
body,td,th {
...
<table width="800" border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#666666">
  ...
  <tr>
    <td height="476"><table width="92%" height="456" border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="#005B5B" bgcolor="#4F5359">
      <tr>
        <td height="36"><div align="center"><span class="style11">PGC PILOT SIGNOFF LIST </span></div></td>
      </tr>
      <tr>
