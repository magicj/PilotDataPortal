...
<body>
<table width="1100" height="95%" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#595E80">
<tr>
<td width="1243" height="60" align="center" valign="middle"><div align="center"><span class="style1">PGC PILOT DATA PORTAL</span></div></td>
</tr>
<tr>
<td valign="top"><table width="95%" height="95%" align="center" cellpadding="4" cellspacing="3" bordercolor="#005B5B" bgcolor="#414967">
    <tr>
          <td height="464" align="center" valign="top"><form id="form1" name="form1" method="post" action="">
                <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                            <td width="23%" height="33">&nbsp;</td>
                            <td width="51%" align="center"><span class="style58 style66">APPLICATION LIST </span></td>
                            <td width="2%">&nbsp;</td>
...
?>
                ...
                <table width="98%" cellpadding="3" cellspacing="2" bgcolor="#666666">
                      <tr>
                      ...
                      <?php do { ?>
                            <tr>
                                  <td bgcolor="#283D62" class="style65"><div align="center"><a href="pgc_access_application_edit.php?app_key=<?php echo $row_Recordset1['app_key']?>" class="AppRows"><?php echo $row_Recordset1['app_key']; ?></a></div></td>
                                  <td bgcolor="#283D62" class="style65"><div align="left" class="AppRows"><?php echo $row_Recordset1['app_name']; ?></div></td>
                                  <td bgcolor="#283D62" class="AppRows"><?php echo $row_Recordset1['app_function']; ?></td>
                                  <td bgcolor="#283D62" class="style65"><div align="left" class="AppRows"><?php echo $row_Recordset1['app_notes']; ?></div></td>
                                  <td bgcolor="#283D62" class="style65"><div align="center" class="AppRows"><?php echo $row_Recordset1['app_active']; ?></div></td>
                                  <td bgcolor="#283D62" class="AppRows"><?php echo $row_Recordset1['app_last_used']; ?></td>
                                  <td bgcolor="#283D62" class="AppRows"><?php echo $row_Recordset1['last_user_name']; ?></td>
                                  <td bgcolor="#283D62" class="AppRows"><?php echo $row_Recordset1['last_user_id']; ?></td>
                                  </tr>
