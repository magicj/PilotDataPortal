        ...
        <tr>
            <td width="1562" height="56" bgcolor="#4F5359"><div align="center" class="style2">
                <table width="60%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td><div align="center">STUDENT VIEW - STUDENT  INSTRUCTION REQUESTS - LIST ALL BY DATE REQUESTED </div></td>
                    </tr>
                    <tr>
        ...
        <tr>
            <td height="465" align="center" valign="top" bgcolor="#4F5359"><table width="98%" border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="#36373A">
              <tr>
                ...
                <td width="127" bgcolor="#35415B" class="style25"><div align="center">DATE &amp; TIME ENTERED </div></td>
                <td width="159" bgcolor="#35415B" class="style25"><div align="center">MEMBER</div></td>
                <td width="108" bgcolor="#35415B" class="style25"><div align="center">DATE REQUESTED </div></td>
              ...
              <?php do { ?>
              <tr>
                <td bgcolor="#35415B"><div align="center"><a href="pgc_request_enter_cfig.php?request_id=<?php echo $row_Requests['request_key']; ?>"><?php echo $row_Requests['request_key']; ?></div></td>
                ...
                <td bgcolor="#35415B"><div align="center"><?php echo $row_Requests['request_key']; ?></div></td>
