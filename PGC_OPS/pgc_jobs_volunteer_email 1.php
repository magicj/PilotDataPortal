<?php
 $test_to = "support@pgcsoaring.org, klausesser10@gmail.com, klausall@comcast.net";
 $to = $JobMemberEmail . ", ". $JobSponsorEmail .", " . $JobLeaderEmail . ", " . "support@pgcsoaring.org, klausesser10@gmail.com, klausall@comcast.net";
