...
mysql_select_db($database_PGC, $PGC);
$query_Recordset1 = "SELECT instructorID, Name, cfig, rec_active FROM pgc_instructors WHERE Name <> '' ORDER BY CFIG ASC, rec_active DESC, name ASC ";
  ...
  <tr>
    <td height="481" valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                            <td width="6%">&nbsp;</td>
                            <td width="18%">&nbsp;</td>
                            <td width="53%"><div align="center"><span class="style26">CFIGS &amp; SIGNERS  - INSTRUCTOR TABLE UPDATE</span></div></td>
                            <td width="20%"><div align="center" class="style33"></div></td>
                            <td width="3%">&nbsp;</td>
                    </tr>
            </table>
                ...
                <form id="form1" name="form1" method="post" action="">
                        <table width="80%" align="center" cellpadding="1" cellspacing="2">
                                <tr>
                                        ...
                                        <td width="65" valign="middle" bgcolor="#324267" class="style29"><div align="center">ACTUAL CFIG</div></td>
                                        </tr>
                                <?php do { ?>
                                        <tr>
                                                <td valign="middle" bgcolor="#324267" ><div align="center"><a href="pgc_non_cfig_list_update.php?instructorID=<?php echo $row_Recordset1['instructorID']; ?>" ><?php echo $row_Recordset1['instructorID']; ?></a></div></td>
                                                ...
                                                <td valign="middle" bgcolor="#324267" class="style29"><div align="center" class="style31"><?php echo $row_Recordset1['cfig']; ?></div></td>
                                                </tr>
