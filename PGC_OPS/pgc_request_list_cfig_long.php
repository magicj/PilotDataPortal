...
<table width="1100" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#000033">
  ...
  <tr>
    <td height="374" bgcolor="#666666"><table width="1080" height="316" align="center" cellpadding="4" cellspacing="3" bordercolor="#005B5B" bgcolor="#005B5B">
        <tr>
          <td width="1064" height="56" bgcolor="#4F5359"><div align="center" class="style2">
        ...
        <tr>
          <td height="215" align="center" valign="top" bgcolor="#4F5359"><table width="1000" border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="#36373A">
              <tr>
              ...
              <?php do { ?>
                <tr>
                  ...
                  <td bgcolor="#35415B"><div align="left"><?php echo $row_Requests['member_name']; ?></div></td>
                  <td bgcolor="#35415B"><div align="center"><?php echo $row_Requests['mydate']; ?></div></td>
                  <td bgcolor="#35415B"><?php echo $row_Requests['request_type']; ?></td>
                  <td bgcolor="#35415B"><?php echo $row_Requests['request_notes']; ?></td>
