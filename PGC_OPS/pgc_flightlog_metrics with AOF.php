...
mysql_select_db($database_PGC, $PGC);
$query_rsGlidersAOF = "SELECT Glider, Count(Glider), Sum(`Time`) FROM " . $pgc_table . " WHERE (Pilot1 <> '' OR Pilot2 <> '') AND Glider <> '' AND flight_type = 'AOF' GROUP BY Glider";
$rsGlidersAOF = mysql_query($query_rsGlidersAOF, $PGC) or die(mysql_error());
$row_rsGlidersAOF = mysql_fetch_assoc($rsGlidersAOF);
$totalRows_rsGlidersAOF = mysql_num_rows($rsGlidersAOF);
                        ...
                        <td height="389" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#2F334F">
                                        ...
                                        <tr>
                                              <td height="114" valign="top"><table width="600" border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="#7C7C8F">
                                                    <tr>
                                                          <td colspan="3" bgcolor="#455463" class="style34"><div align="center"><?php echo $_SESSION['$flight_year']. " " ?>AOF  ACTIVITY </div></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <?php do { ?>
                                                    <tr>
                                                          <td bgcolor="#516375" class="style16"><div align="center" class="style37"><strong><a href="pgc_flightlog_lookup.php?recordID=<?php echo $row_rsGlidersAOF['Glider']; ?>"><?php echo $row_rsGlidersAOF['Glider']; ?></a></div></td>
                                                          <td bgcolor="#516375" class="style16"><div align="center" class="style37"><strong><?php echo $row_rsGlidersAOF['Count(Glider)']; ?></div></td>
                                                          <td bgcolor="#516375" class="style16"><div align="center" class="style37"><strong><?php echo $row_rsGlidersAOF['Sum(`Time`)']; ?></div></td>
                                                    </tr>
