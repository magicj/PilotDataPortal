...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  /*  Send Email  */
	...
	$to = "Jack@nni.com, michaelclittle@gmail.com, support@pgcsoaring.org, " . $_SESSION['MM_Username'] ;
                        ...
                        <tr>
                              <td width="1562" height="57" valign="top" bgcolor="#0A335C"><div align="center">
                                      <table width="95%" border="0" cellspacing="0" cellpadding="0">
                                              ...
                                              <tr>
                                                      <td height="16" valign="top"><p align="center" class="style43">Squawk e-mail notifications will be sent to Jack Goritski and Michael Little.</p></td>
                                              </tr>
                                              <tr>
                                ...
                                <td height="277" align="center" valign="top" bgcolor="#0A335C"><form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                                        ...
                                        <table width="575" align="center" bgcolor="#999999">
                                                <tr valign="baseline">
                                                        ...
                                                        <td width="446" valign="middle"><span class="style40"><?php echo $_SESSION['MM_PilotName']; ?></span> &nbsp;</td>
                                                </tr>
                                                
                                                <tr valign="baseline">
                                                        <td align="right" valign="middle" nowrap class="style35"><div align="left" class="style38">Squawk Date </div></td>
                                                        <td valign="middle"><input name="sq_date" type="text" size="10" value=<?php echo date("Y-m-d")?>>
                                                                <a href="#"
					   name="anchor2" class="style44" id="anchor2" onclick="cal.select(document.forms['form1'].sq_date,'anchor2','yyyy-MM-dd'); return false">Select From Calendar</a></td>
                                                </tr>
                                                <tr valign="baseline">
                                                        <td align="right" valign="middle" nowrap class="style17"><div align="left" class="style38">Equipment</div></td>
                                                        <td valign="middle"><select name="sq_equipment">
                                                                <?php
do {  
?>
...
?>
                                                ...
                                                <tr valign="baseline">
                                                        <td align="right" valign="middle" nowrap><div align="left" class="style37">Squawk Issue</div></td>
                                                        <td><textarea name="sq_issue" cols="70" rows="10"></textarea></td>
                                                </tr>
                                                <tr valign="baseline">
                                                        <td nowrap align="right">&nbsp;</td>
                                                        <td><input type="submit" value="Submit Squawk"></td>
                                                </tr>
                                        </table>
