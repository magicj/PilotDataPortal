    ...
    <td height="257"><table width="98%" height="251" border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="#005B5B" bgcolor="#4F5359">
      <tr>
        <td height="25"><div align="center">
            <p class="style24">CURRENT FIELD DUTY and SUB DUTY SELECTOR</p>
            <p class="style24 style25">(This example assumes Kochanski, Ken is logged-in ... the live system will use the actual logged-in member name.) </p>
        </div></td>
      </tr>
      
      <tr>
        <td height="165" align="center" valign="top"><form id="form1" name="form1" method="post" action="">
          <p><span class="style22 style23"><?php echo $_SESSION[page_msg]; ?></span></p>
          <table width="98%" cellpadding="3" cellspacing="3" bordercolor="#000000" bgcolor="#666666">
            <tr>
                ...
                <td colspan="4" bgcolor="#254949"><div align="center" class="style21"> MEMBER SELECTABLE SUB DUTY</div></td>
                </tr>
            <tr>
            ...
            <?php do { ?>
            <tr>
              <td width="75" bgcolor="#4F0000"><span class="style16"><?php echo $row_rsFieldDuty['date']; ?></span></td>
              ...
              <td bgcolor="#2B5555"><div align="center" class="style16"><a href="pgc_field_duty_update_sub.php?dutydate=<?php echo $row_rsFieldDuty['date']. 'fm_sub' ; ?>"><?php echo $row_rsFieldDuty['fm_sub']; ?></a></div></td>
              <td bgcolor="#2B5555"><div align="center" class="style16"><a href="pgc_field_duty_update_sub.php?dutydate=<?php echo $row_rsFieldDuty['date']. 'afm1_sub' ; ?>"><?php echo $row_rsFieldDuty['afm1_sub']; ?></a></div></td>
              <td bgcolor="#2B5555"><div align="center" class="style16"><a href="pgc_field_duty_update_sub.php?dutydate=<?php echo $row_rsFieldDuty['date']. 'afm2_sub' ; ?>"><?php echo $row_rsFieldDuty['afm2_sub']; ?></a></div></td>

              <td bgcolor="#2B5555"><div align="center" class="style16"><a href="pgc_field_duty_update_sub.php?dutydate=<?php echo $row_rsFieldDuty['date']. 'afm3_sub' ; ?>"><?php echo $row_rsFieldDuty['afm3_sub']; ?></a></div></td>
            </tr>
