...
<title>Flightlog History Updates</title>
<style type="text/css">
<!--
body,td,th {
...
.style25 {font-size: 16px; font-weight: bold; color: #DD4800; }
-->
</style></head>
...
<table width="800" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#51547B">
  ...
  <tr>
    <td height="514" bgcolor="#666666"><table width="92%" height="440" align="center" cellpadding="2" cellspacing="2" bordercolor="#005B5B" bgcolor="#414567">
      <tr>
        <td height="36"><div align="center">
                <table width="98%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                                <td width="31%">&nbsp;</td>
                                <td width="44%"><div align="center"><span class="style11"> Flightlog Edit History </span></div></td>
                                <td width="25%"><div align="center"><span class="style25"><a href="/PGCWeb/PGC_OPS/pgc_flightlog_history_new_date.php">Add New Date</a></span></div></td>
                        </tr>
                </table>
        </div></td>
      </tr>
      <tr>
        <td height="373" bgcolor="#4F5359"><p align="center" class="style18">
            <table width="177" align="center" cellpadding="2" cellspacing="2" bgcolor="#6F39C6">
                ...
                <?php do { ?>
                    <tr>
                        <td bgcolor="#6633FF"><div align="center" class="style11"><span class="style23"><a href="pgc_flightlog_list_history_edit.php?recordDATE=<?php echo $row_rsFlightlog['Date']; ?>"><?php echo $row_rsFlightlog['Date']; ?></a></span></div></td>
                    </tr>
      ...
      <tr>
        <td height="21"><div align="center"><strong class="style11"><a href="../PGC_OPS/pgc_portal_menu.php" class="style16">BACK TO MAINTENANCE MENU</a></strong></div></td>
      </tr>
    </table></td>
  </tr>
</table>
