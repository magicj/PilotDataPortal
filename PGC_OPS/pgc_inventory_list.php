...
$delete_query = "DELETE FROM pgc_inventory WHERE rec_deleted = 'Y'";
                        ...
                        <tr>
                          <td width="1562" height="26" valign="middle" bgcolor="#005B5B"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td width="30%"><div align="center"><span class="style42">HARDWARE INVENTORY LIST </span></div></td>
                              <td width="35%"><table width="99%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="52%" class="style54"><div align="center"></div></td>
                                  <td width="5%">&nbsp;</td>
                                  <td width="43%"><a href="pgc_inventory_add.php"><img src="Graphics/AddStockButton copy.png" alt="AddStock" width="130" height="30" border="0" /></a></td>
                                </tr>
                              </table></td>
                            </tr>
                          </table></td>
                        ...
                        <tr>
                          <td height="464" align="center" valign="top" bgcolor="#005B5B"><p>&nbsp;</p>
                            <table cellpadding="4" cellspacing="3" bgcolor="#A2B3B3">
                              <tr>
                                <td bgcolor="#35415B" class="style16"><div align="center"><strong><em>KEY</em></strong></div></td>
                              ...
                              <?php do { ?>
                                <tr>
                                  <td bgcolor="#48597B"><span class="style55"><a href="pgc_inventory_edit.php?inv_key=<?php echo $row_Inventory['inv_key']?>"><?php echo $row_Inventory['inv_key']; ?></a></span></td>
