...
$query_Recordset1 = "SELECT * FROM pgc_members WHERE active = 'YES' ORDER BY NAME ASC";
    ...
    <td height="514"><table width="92%" height="448" align="center" cellpadding="2" cellspacing="2" bordercolor="#005B5B" bgcolor="#464E62">
      <tr>
        <td height="44"><div align="center">
              <p><span class="style11">MODIFY ACTIVE MEMBER ADMIN ROLE</span><span class="style22"></span></p>
      ...
      <tr>
        <td height="373"><table align="center" cellpadding="2" cellspacing="2" bgcolor="#7D8A89">
            <tr>
              ...
              <td width="165" align="center" bgcolor="#3D4461"><em class="style351"><strong>ADMIN ROLE</strong></em></td>
            </tr>
            <?php do { ?>
              <tr>
                <td bgcolor="#3D4461"><a href="pgc_list_member_role_edit.php?USER_ID=<?php echo $row_Recordset1['USER_ID']; ?>"> <span class="style16"><?php echo $row_Recordset1['USER_ID']; ?></span>&nbsp; </a> </td>
...
<?php
 ...
 ?>
                ...
                <td bgcolor="#3D4461"><div align="center"><span class="style17"><?php echo $row_Recordset1['ROLE']; ?></span>&nbsp; </div></td>
              </tr>
