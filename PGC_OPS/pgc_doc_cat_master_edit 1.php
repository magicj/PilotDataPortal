...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE pgc_doc_category_master SET rec_posted=%s, rec_modified_id=%s, rec_active=%s, rec_deleted=%s WHERE rec_key=%s",
  ...
  $updateGoTo = "pgc_doc_cat_master_create.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_PGC, $PGC);
$query_Recordset1 = sprintf("SELECT * FROM pgc_doc_category_master WHERE rec_key = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<table width="939" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#666666">
    <tr>
      <td width="900" height="5" align="center" bgcolor="#387272"><p class="JobBanner">PGC CAT MASTER - EDIT</p></td>
  </tr>
    <tr>
