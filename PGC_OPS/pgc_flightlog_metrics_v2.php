...
$query_Recordset1 = "SELECT * FROM pgc_flight_tables";
    ...
    <tr>
        <td><div align="center">
                <table width="97%" cellspacing="0" cellpadding="0">
                    <tr>
                            <td width="26%">&nbsp;</td>
                            <td width="46%"><div align="center"><span class="style1">PGC DATA PORTAL</span></div></td>
                            <td width="28%"><?php echo $_SESSION['pgc_year'] ?>&nbsp;</td>
                    </tr>
                    <tr>
                            <td>&nbsp;</td>
                            <td><div align="center"><span class="style1"><?php echo $_SESSION['$flight_year']. " " ?>FLIGHT SHEET METRICS (v2) </span></div></td>
                            <td><form id="form1" name="form1" method="get" action="pgc_flightlog_metrics_v2.php">
                ...
                <td height="389" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td height="52" valign="top">&nbsp;
                        <table width="600" border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="#7C7C8F">
                          <tr>
                            <td colspan="5" bgcolor="#455463" class="style34"><div align="center">Current Year - PGC Glider Inspection Log (Hours) </div></td>
                          </tr>
                          <tr>
                    ...
                    <tr>
                        <td valign="top"><p>&nbsp;</p>
                          <table width="600" border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="#7C7C8F">
                            <tr>
                              <td colspan="3" bgcolor="#455463" class="style34"><div align="center"><span class="style34"><?php echo $_SESSION['$flight_year']. " " ?></span>FLIGHT ACTIVITY </div></td>
                            </tr>
                            <tr>
                            ...
                            <?php do { ?>
                            <tr>
                                <td bgcolor="#516375" class="style16"><div align="center" class="style37"><strong><a href="pgc_flightlog_lookup_v2.php?recordID=<?php echo $row_rsGliders['Glider']; ?>"><?php echo $row_rsGliders['Glider']; ?></a></div></td>
