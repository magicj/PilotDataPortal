        ...
        <td height="458" valign="top"><table width="100%" height="427" align="center" cellpadding="2" cellspacing="2" bordercolor="#005B5B" bgcolor="#4F5359">
                <tr>
                        <td height="389" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#2F334F">
                                        ...
                                        <tr>
                                              <td height="256" valign="top"><table width="671" border="0" align="center" cellpadding="2" cellspacing="2">
                                                    <tr>
                                                          <td colspan="6" bgcolor="#455463" class="style35">FLIGHT OPS TO DATE - REALTIME SEASONAL COMPARISON</td>
                                                    </tr>
                                                    <tr>
                                                          <td width="148" class="style34">SEASON</td>
                                                          <td width="113" class="style34">TOTAL FLIGHTS</td>
                                                          <td width="65" class="style34">TRN</td>
                                                          <td width="65" class="style34">WINCH</td>
                                                          <td width="97" class="style34">TOTAL TIME</td>
                                                          <td width="145" class="style34">OPERATING DAYS</td>
                                                    </tr>
                                                    <?php do { ?>
                                                    <tr>
                                                          <td align="center" bgcolor="#6B5A67" class="BoldMetrics"><?php echo $row_FlightsCurrent['2014']; ?></td>
                                                    ...
                                                    <tr>
                                                          <td height="22" align="center" bgcolor="#6B5A67" class="BoldMetrics"><?php echo $row_Flights2013['2013']; ?></td>
                                                    ...
                                                    <tr>
                                                          <td align="center" bgcolor="#6B5A67" class="BoldMetrics"><?php echo $row_Flights2012['2012']; ?></td>
                                                    ...
                                                    <tr>
                                                          <td align="center" bgcolor="#6B5A67" class="BoldMetrics"><?php echo $row_Flights2011['2011']; ?></td>
                                                    ...
                                                    <tr>
                                                          <td align="center" bgcolor="#6B5A67" class="BoldMetrics"><?php echo $row_Flights2010['2010']; ?></td>
                                                    ...
                                                    <tr>
                                                          <td height="71" colspan="6" align="center" bgcolor="#6B5A67" class="BoldMetrics"><table width="90%" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                            <td align="center" class="BoldMetrics">* Total Flights  includes displayed TRN and WINCH winch counts</td>
                                                                      </tr>
                                                                      <tr>
                                                                            <td height="22" align="center"><span class="BoldMetrics">** A day is counted as 'operational' if one or more flights are logged</span></td>
                                                                      </tr>
                                                    </table></td>
                                                          </tr>
