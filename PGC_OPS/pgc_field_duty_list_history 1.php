...
$Recordset1 = mysql_query($query_Recordset1, $PGC) or die(mysql_error());
 ...
 mysql_select_db($database_PGC, $PGC);
$query_rsFieldDuty = "SELECT date, date_format(date,'%m/%d/%y') as mydate, date_format(date,'%W') as daydate, fm, fm_email, fm_count, afm_count, afm1, afm1_email, afm2, afm2_email, afm3, afm3_email, cfig, cfig_email, tp1, tp2, `session` FROM pgc_field_duty ORDER BY `date` ASC";
                    ...
                    <td bgcolor="#274987"><div align="center">
                          <table width="99%" cellspacing="0" cellpadding="0">
                                <tr>
                                      ...
                                      <td width="37%" align="center"><span class="style24"> DUTY SCHEDULE - HISTORY VIEW</span></td>
...
<table border="0" width="40%" align="center">
      ...
      <tr>
        <td height="106" bgcolor="#1C3462"><div align="center" class="style20">
