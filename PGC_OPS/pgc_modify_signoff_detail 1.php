...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE IGNORE pgc_pilot_signoffs SET 30_day_email = DATE_ADD(CURDATE(), INTERVAL 5 YEAR), signoff_type=%s, signoff_date=%s, instructor=%s, delete_record=%s, modified_by=%s, modified_date=%s WHERE signoffID=%s",
...
<table width="900" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#595E80">
  ...
  <tr>
    <td height="476"><table width="92%" height="456" align="center" cellpadding="2" cellspacing="2" bordercolor="#005B5B" bgcolor="#4F5359">
      ...
      <tr>
        <td height="373" align="center" valign="top" bgcolor="#424A66">&nbsp;
            <p>&nbsp;</p>
            <p>
          </p>
          <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
            <table align="center" cellpadding="2" cellspacing="3">
              <tr valign="baseline">
                ...
                <td width="276" valign="middle" bgcolor="#0F4E55"><div align="left"><strong><?php echo $row_rsSignoffs['signoffID']; ?></strong></div></td>
              </tr>
...
do {  
?>
                        <option value="<?php echo $row_rsSignoffType['description']?>"<?php if (!(strcmp($row_rsSignoffType['description'], $row_rsSignoffs['signoff_type']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsSignoffType['description']?></option>
                        <?php
...
?>
              ...
              <tr valign="baseline">
                ...
                <td valign="middle" bgcolor="#0F4E55"><div align="left">
                    <input name="signoff_date" type="text" value="<?php echo $row_rsSignoffs['signoff_date']; ?>" size="10" maxlength="10">
                    <a href="#"
					   name="anchor2" class="style44" id="anchor2" onclick="cal.select(document.forms['form1'].signoff_date,'anchor2','yyyy-MM-dd'); return false">Select From Calenda</a></div></td>
              </tr>
              <tr valign="baseline">
                ...
                <td valign="middle" bgcolor="#0F4E55"><div align="left">
                    <select name="instructor">
                        <?php
do {  
?><option value="<?php echo $row_rsInstructors['Name']?>"<?php if (!(strcmp($row_rsInstructors['Name'], $row_rsSignoffs['instructor']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsInstructors['Name']?></option>
                        <?php
...
?>
              ...
              <tr valign="baseline">
                <td height="45" colspan="2" align="right" valign="middle" nowrap bgcolor="#0E4656"><table width="98%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                        <td width="50%"><div align="center">
                                                <input name="submit" type="submit" value="Update record" />
                                        </div></td>
                                        <td width="50%"><div align="center"><span class="style47"><a href=" <?php echo$_SESSION['last_signoff_select'];?>">CANCEL UPDATE</a> </span> </div></td>
                                </tr>
                        </table></td>
                </tr>
            </table>
