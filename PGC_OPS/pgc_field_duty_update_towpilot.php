...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE pgc_field_duty SET tp1=%s, tp2=%s WHERE `date`=%s",
 ...
 $updateGoTo = "pgc_field_duty_list_towpilot.php";
...
<table width="800" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#666666">
  ...
  <tr>
    <td height="446"><table width="92%" height="440" align="center" cellpadding="2" cellspacing="2" bordercolor="#005B5B" bgcolor="#2D3240">
      <tr>
        <td height="36" bgcolor="#545E78"><div align="center"><span class="style11"> DUTY UPDATE -  TOW PILOTS </span></div></td>
      </tr>
      <tr>
...
?>
      ...
      <tr>
          <td height="21" bgcolor="#545E78"><div align="center"><strong class="style11"><a href="../07_members_only_pw.php" class="style20">BACK TO MEMBERS PAGE</a></strong></div></td>
      </tr>
    </table></td>
  </tr>
</table>
