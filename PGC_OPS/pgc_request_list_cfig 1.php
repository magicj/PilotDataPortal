...
/* --       Update E-Mails         --*/
/*
$runSQL = "UPDATE pgc_request SET cfig1_email = '', cfig2_email = '', assign_cfig_email =''";
$Result1 = mysql_query($runSQL, $PGC) or die(mysql_error());

$runSQL = "UPDATE pgc_request A, pgc_members B SET A.cfig1_email = B.USER_ID
WHERE A.request_cfig = B.NAME";
$Result1 = mysql_query($runSQL, $PGC) or die(mysql_error());

$runSQL = "UPDATE pgc_request A, pgc_members B SET A.cfig2_email = B.USER_ID
WHERE A.request_cfig2 = B.NAME";
$Result1 = mysql_query($runSQL, $PGC) or die(mysql_error());

$runSQL = "UPDATE pgc_request A, pgc_members B SET A.member_id = B.USER_ID
WHERE A.member_name = B.NAME";
$Result1 = mysql_query($runSQL, $PGC) or die(mysql_error());

$runSQL = "UPDATE pgc_request A, pgc_members B SET A.assign_cfig_email = B.USER_ID
WHERE A.accept_cfig = B.NAME";
$Result1 = mysql_query($runSQL, $PGC) or die(mysql_error());
*/
      ...
      <tr>
        <td width="1126" height="51" bgcolor="#002B55"><div align="center" class="style2">
            <table width="98%" cellspacing="0" cellpadding="0">
              <tr>
                <td width="15%" height="16" bgcolor="#0042CA"><div align="center"><a href="pgc_request_enter_member_by_cfig.php">ENTER A REQUEST FOR MEMBER</a></div></td>
              ...
              <tr>
                ...
                <td><div align="right" class="style34">
                    <div align="center"><a href="pgc_request_vacation_view_cfig_by_cfig.php" class="style35">DISPLAY CFIG SCHEDULE</a></div>
                </div></td>
              </tr>
            </table>
        </div></td>
      ...
      <tr>
        <td height="276" align="center" valign="top" bgcolor="#002B55"><table border="0" align="center" cellpadding="1" cellspacing="3" bgcolor="#36373A">
            ...
            <tr>
			  ...
			  ?>
              <td bgcolor="<?php echo $color1; ?>"><div align="center"><a href="pgc_request_modify_cfig.php?request_id=<?php echo $row_Requests['request_key']; ?>"><?php echo $row_Requests['request_key']; ?></a></div></td>
