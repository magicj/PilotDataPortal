...
AND LENGTH(TRIM(A.member_name)) = 0
        ...
        <tr>
          <td width="1126" height="51" bgcolor="#633845"><div align="center" class="style2">
            <table width="98%" cellpadding="0" cellspacing="0" bgcolor="#633845">
              <tr>
                <td width="11%" height="16" bgcolor="#0042CA" class="style25 style37"><div align="center" class="style38"><a href="pgc_request_enter_member.php">ENTER TRAINING REQUEST</a> </div></td>
                <td width="72%"><div align="center" class="style36">MEMBER ENTER /    MODIFY  REQUESTS</div></td>
                <td width="17%"><div align="center"><span class="style33">RED = CFIG OFF DUTY</span></div></td>
              </tr>
              <tr>
                <td height="16">&nbsp;</td>
                ...
                <td><div align="right" class="style34">
                  <div align="center"><a href="pgc_request_vacation_view.php" class="style35">DISPLAY CFIG OFF-DUTY SCHEDULE </a></div>
                </div></td>
              </tr>
              <tr>
                <td height="16">&nbsp;</td>
                <td><div align="center">Contact Joe Beyer or the assigned CFIG to modify a request with an Assigned CFIG.</div></td>
                <td>&nbsp;</td>
              </tr>
            </table>
          </div></td>
