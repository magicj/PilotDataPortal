...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE pgc_field_duty SET fm=%s, afm1=%s, afm2=%s, afm3=%s, fm_sub=%s, afm1_sub=%s, afm2_sub=%s, afm3_sub=%s, `session`=%s, `date`=%s, `delete_record`=%s  WHERE `date`=%s",
                       ...
                       GetSQLValueString($_POST['fm_sub'], "text"),
                       GetSQLValueString($_POST['afm1_sub'], "text"),
                       GetSQLValueString($_POST['afm2_sub'], "text"),
                       GetSQLValueString($_POST['afm3_sub'], "text"),
                       GetSQLValueString($_POST['session'], "int"),
                       GetSQLValueString($_POST['date2'], "text"),
...
<table width="800" border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#666666">
  ...
  <tr>
    <td height="514"><table width="92%" height="417" border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="#005B5B" bgcolor="#4F5359">
      <tr>
        <td height="36"><div align="center"><span class="style11">FIELD DUTY UPDATE - ADMIN LEVEL </span></div></td>
      </tr>
      <tr>
        <td height="373"><p align="center">&nbsp;</p>
            ...
            <table width="288" align="center" cellpadding="3" cellspacing="3" bordercolor="#000000" bgcolor="#4F4F4F">
              <tr valign="baseline">
                ...
                <td width="193" bgcolor="#666666"><em><strong>
                  <label>
                  <input name="date2" type="text" id="date2" value="<?php echo $row_rsFieldDuty['date']; ?>" size="10" maxlength="10" />
                  </label>
                </strong></em></td>
              </tr>
              <tr valign="baseline">
...
?>
              ...
              <tr valign="baseline">
                <td align="right" nowrap bgcolor="#2B5555"><div align="left"><em><strong>FM SUB :</strong></em></div></td>
                <td bgcolor="#2B5555">
                  <div align="left">
                    <select name="fm_sub" id="fm_sub">
                      <?php
do {  
?>
                      <option value="<?php echo $row_rsMembers['NAME']?>"<?php if (!(strcmp($row_rsMembers['NAME'], $row_rsFieldDuty['fm_sub']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsMembers['NAME']?></option>
                      <?php
} while ($row_rsMembers = mysql_fetch_assoc($rsMembers));
  $rows = mysql_num_rows($rsMembers);
  if($rows > 0) {
...
?>
              ...
              <tr valign="baseline">
                <td align="right" nowrap bgcolor="#2B5555"><div align="left"><em><strong>AFM SUB:</strong></em></div></td>
                <td bgcolor="#2B5555">
                  <div align="left">
                    <select name="afm1_sub" id="afm1_sub">
                      <?php
do {  
?>
                      <option value="<?php echo $row_rsMembers['NAME']?>"<?php if (!(strcmp($row_rsMembers['NAME'], $row_rsFieldDuty['afm1_sub']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsMembers['NAME']?></option>
                      <?php
} while ($row_rsMembers = mysql_fetch_assoc($rsMembers));
  $rows = mysql_num_rows($rsMembers);
  if($rows > 0) {
...
?>
              ...
              <tr valign="baseline">
                ...
                <td bgcolor="#2B5555">
                  <div align="left">
                    <select name="afm2_sub" id="afm2_sub">
                      <?php
do {  
?>
                      <option value="<?php echo $row_rsMembers['NAME']?>"<?php if (!(strcmp($row_rsMembers['NAME'], $row_rsFieldDuty['afm2_sub']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsMembers['NAME']?></option>
                      <?php
} while ($row_rsMembers = mysql_fetch_assoc($rsMembers));
  $rows = mysql_num_rows($rsMembers);
  if($rows > 0) {
...
?>
              ...
              <tr valign="baseline">
                ...
                <td bgcolor="#2B5555">
                  <div align="left">
                    <select name="afm3_sub" id="afm3_sub">
                      <?php
do {  
?>
                      <option value="<?php echo $row_rsMembers['NAME']?>"<?php if (!(strcmp($row_rsMembers['NAME'], $row_rsFieldDuty['afm3_sub']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rsMembers['NAME']?></option>
                      <?php
} while ($row_rsMembers = mysql_fetch_assoc($rsMembers));
  $rows = mysql_num_rows($rsMembers);
  if($rows > 0) {
