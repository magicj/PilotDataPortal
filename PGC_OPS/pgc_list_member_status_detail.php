...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE pgc_members SET active=%s WHERE USER_ID=%s",
...
<table width="900" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#595E80">
  ...
  <tr>
    <td height="514"><table width="92%" height="440" align="center" cellpadding="2" cellspacing="2" bordercolor="#005B5B" bgcolor="#464E62">
      <tr>
        <td height="36"><div align="center"><span class="style11">MODIFY MEMBER STATUS </span></div></td>
      </tr>
      <tr>
        <td height="373">&nbsp;
          <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
            <table width="426" align="center" cellpadding="3" cellspacing="3" >
              ...
              <tr valign="baseline">
                <td align="right" nowrap bgcolor="#274669"><div align="left">ACTIVE:</div></td>
                <td bgcolor="#274669"><p>
                  <select name="active">
                    <option value="YES" <?php if (!(strcmp("YES", $row_Recordset1['active']))) {echo "selected=\"selected\"";} ?>>YES</option>
                    <option value="NO" <?php if (!(strcmp("NO", $row_Recordset1['active']))) {echo "selected=\"selected\"";} ?>>NO</option>
                  </select>
                  <label></label>
</p>
                  </td>
      ...
      <tr>
        <td height="21"><div align="center"><strong class="style11"><a href="pgc_portal_menu.php" class="style20">BACK TO PDP MAINTENANCE MENU</a><a href="../PGC_OPS/pgc_portal_menu.php" class="style16"></a></strong></div></td>
      </tr>
    </table></td>
  </tr>
</table>
