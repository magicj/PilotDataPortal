...
$Result1 = mysql_query($runSQL, $PGC) or die(mysql_error());
/* Update Combos */
$runSQL2 = "INSERT IGNORE INTO pgc_doc_combos (doc_category, doc_sub_category, doc_combo) SELECT doc_category, doc_sub_category, CONCAT(doc_category, ' ~ ' , doc_sub_category) FROM pgc_doc_lib_list";
...
mysql_select_db($database_PGC, $PGC);
$query_Recordset1 = "SELECT rec_id, doc_file_name, doc_display_name, doc_category, doc_sub_category, doc_source, date_format(doc_posted,'%M %e, %Y') as docdate, date_posted, doc_display, doc_modified_id, doc_path, doc_upload_link, combo_key FROM pgc_doc_lib_list ORDER BY doc_category, doc_sub_category, doc_display_name";
...
<title>PGC Data Portal - Admin View</title>
<style type="text/css">
<!--
body {
...
<table width="1200" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#666666">
    <tr>
      <td height="20" align="center" bgcolor="#387272"><p class="JobBanner">ADMIN VIEW - PGC DOCUMENT LIBRARY - PROTOTYPE</p></td>
  </tr>
    <tr>
      <td height="481" align="center"><table width="96%" height="447" align="center" cellpadding="2" cellspacing="2" bordercolor="#005B5B" bgcolor="#4F5359">
            ...
            <tr>
              <td height="373" colspan="5" align="center" valign="top"><table width="99%" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="48%" align="left"><label for="select"></label>
                      <form id="form1" name="form1" method="get" action="pgc_doc_lib_admin.php">
...
?>
                ...
                <table width="95%" border="0" cellpadding="3" cellspacing="3" class="JobGrid">
                      ...
                      <td align="center" bgcolor="#003559"><span class="JobHeader">DISPLAY NAME (EDIT)</span></td>
                      <td align="center" bgcolor="#003559"><span class="JobHeader">DISPLAY</span></td>
                      <td align="center" bgcolor="#003559"><span class="JobHeader">UPLOAD FILE  NAME</span></td>
                      <td align="center" bgcolor="#003559"><span class="JobHeader">UPLOAD FOLDER</span></td>
                ...
                <?php do { ?>
                  ...
                  <tr>
                    ...
                    <td bgcolor="#004879"><a href="pgc_doc_lib_edit.php?rec_id= <?php echo $row_Recordset1['rec_id'] ?>"><?php echo $row_Recordset1['doc_display_name']; ?></a></a></td>
                    <td align="center" bgcolor="#004879"><?php echo $row_Recordset1['doc_display']; ?></td>
                    <td align="center" bgcolor="#004879"><?php echo $row_Recordset1['doc_file_name']; ?></td>
                    <td align="center" bgcolor="#004879"><?php echo $row_Recordset1['doc_path']; ?></td>
                    ...
                    <td align="center" bgcolor="#004879"><?php echo $row_Recordset1['doc_source']; ?></td>
                    <td width="150" align="center" bgcolor="#004879"><?php echo $row_Recordset1['date_posted']; ?></td>
                  </tr>
