...
$Result1 = mysql_query($deleteSQL, $PGC) or die(mysql_error());
 ...
 /* Update Email ================ */
$deleteSQL = "UPDATE pgc_signoff_nofly A, pgc_members B SET A.pgc_pilot_email = B.user_id WHERE A.pilot_name = B.NAME" ;
$Result1 = mysql_query($deleteSQL, $PGC) or die(mysql_error());
...
<table width="800" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#666666">
  ...
  <tr>
    <td height="514"><table width="92%" height="440" align="center" cellpadding="2" cellspacing="2" bordercolor="#005B5B" bgcolor="#4F5359">
      <tr>
        <td height="36" bgcolor="#9D1C1C"><div align="center"><span class="style11"> ACTIVE MEMBER - EMAIL EXPIRED CRITICAL SIGNOFFS</span></div></td>
      </tr>
      <tr>
        <td height="373" valign="top" bgcolor="#2C364E"><p align="center">
<table align="center" cellpadding="3" cellspacing="1" bgcolor="#666666">
            <tr>
              <td width="140" bgcolor="#0B3A40"><div align="center" class="style17">MEMBER NAME </div></td>
              <td width="281" bgcolor="#0B3A40"><div align="center" class="style17">EXPIRED CRITICAL SIGNOFFS</div></td>
            </tr>
            <?php do { ?>
              <tr>
