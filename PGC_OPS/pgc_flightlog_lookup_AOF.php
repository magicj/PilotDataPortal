...
$query_Flightlog = sprintf("SELECT * FROM " . $pgc_table . " WHERE flight_type = 'AOF' AND Time > 0 ORDER BY `Date` DESC", GetSQLValueString($colname_Flightlog, "text"));
            ...
            <table width="100%">
                <tr>
                  ...
                  <td width="9%"><div align="center"></div></td>
                    <td width="59%"><div align="center"><span class="style1">PGC DATA PORTAL - AOF FLIGHT SHEET  </span></div></td>
            ...
            <tr>
                <td height="373" valign="top"><table width="99%" align="center" cellpadding="2" cellspacing="2" bgcolor="#666666">
                                <tr>
                                    ...
                                    <td width="25%" bgcolor="#66CCFF" class="style25"><div align="center" class="style30">Notes</div></td>
                                </tr>
                                <?php do { ?>
                                <tr>
                                  <td bgcolor="#FFFFFF" class="style25"><div align="center" class="style32"><?php echo $row_Flightlog['Key']; ?></div></td>
                                    <td bgcolor="#FFFFFF" class="style31"><div align="center"><?php echo $row_Flightlog['Date']; ?></div></td>
