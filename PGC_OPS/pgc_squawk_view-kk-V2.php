...
$query_Recordset3 = "SELECT * FROM pgc_status_options";
...
$_SESSION['sq_status'] = $_POST[select1]; $_SESSION['sq_xxx'] = $_POST[select]; $_SESSION['sq_2'] = $_POST[select2]; 
                          ...
                          <td height="464" align="center" valign="top" bgcolor="#005B5B"><p><span class="style54 style58 style57">Select SQUAWK ID to Add Work Tasks and Hardware needed to remedy issue</span><span class="style57">&nbsp;</span></p>
                            <form id="form1" name="form1" method="post" action="">
                              ...
                              <table width="950" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                  <td width="244"><select name="select2">
                                    <?php
do {  
?>
                                    <option value="<?php echo $row_Recordset3['sq_status']?>"<?php if (!(strcmp($row_Recordset3['sq_status'], $_SESSION['sq_2']))) {echo "selected=\"selected\"";} ?>><?php echo $row_Recordset3['sq_status']?></option>
                                    <?php
...
?>
                                  ...
                                  <td width="287"><select name="select" size="1">
                              ...
                              <tr>
                                <td width="176"><?php echo $_SESSION['sq_2'] ?></td>
                                <td width="176">&nbsp;</td>
                                <td width="168"><?php echo $_SESSION['sq_xxx'] ?>&nbsp;</td>
                                <td width="27">&nbsp;</td>
                                <td width="29"><?php echo $_SESSION['sq_status'] ?></td>
                              </tr>
                            </table>
                            </form>
