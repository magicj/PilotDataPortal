...
if (!isset($_SESSION)) {
 ...
 $subject = "At Expiring PGC Signoffs pgm" ;
...
If ($expiry_email_run < date("Y-m-d")) {
 ...
 $to = "klausall@comcast.net, jguimondjr@verizon.net, klfranz13@comcast.net, phil.klauder@verizon.net, kilokilo@verizon.net";
 $to = "kilokilo@verizon.net";
...
/* echo $emaillog;  */
 ...
 $to = $member_email . ", klausall@comcast.net, phil.klauder@verizon.net, jguimondjr@verizon.net, klfranz13@comcast.net, kilokilo@verizon.net";
