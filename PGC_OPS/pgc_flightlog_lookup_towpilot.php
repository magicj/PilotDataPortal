...
$query_Flightlog = sprintf("SELECT * FROM " . $pgc_table . " WHERE `Tow Pilot` = %s AND Time > 0 ORDER BY `Date` DESC", GetSQLValueString($colname_Flightlog, "text"));
            ...
            <tr>
                <td height="373" valign="top"><table width="99%" align="center" cellpadding="2" cellspacing="2" bgcolor="#666666">
                                <tr>
                                    ...
                                    <td bgcolor="#66CCFF" class="style25"><div align="center">Date</div></td>
...
-->
            ...
            <tr>
                <td height="28"><?php /*echo $query_Flightlog*/ ?>&nbsp;</td>
            </tr>
        </table></td>
    </tr>
</table>
