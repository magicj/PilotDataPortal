...
$query_Requests = "SELECT * FROM pgc_request ORDER BY request_date ASC, request_time ASC";
...
<title>PGC Data Portal - List Requests</title>
<style type="text/css">
<!--
body,td,th {
    ...
    <td height="440" bgcolor="#666666"><table width="900" height="565" align="center" cellpadding="4" cellspacing="3" bordercolor="#005B5B" bgcolor="#005B5B">
        <tr>
            <td width="1562" height="56" bgcolor="#4F5359"><div align="center" class="style2">
                <table width="60%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td><div align="center">PGC INSTRUCTION - LIST ALL BY DATE REQUESTED </div></td>
                    </tr>
                    <tr>
        ...
        <tr>
            <td height="465" align="center" valign="top" bgcolor="#4F5359"><table width="98%" border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="#36373A">
              <tr>
                <td bgcolor="#35415B" class="style25"><div align="center">DATE &amp; TIME ENTERED </div></td>
                <td bgcolor="#35415B" class="style25"><div align="center">MEMBER</div></td>
                <td width="12" bgcolor="#35415B" class="style25"><div align="center">DATE REQUESTED </div></td>
                <td bgcolor="#35415B" class="style25"><div align="center">TIME</div></td>
              ...
              <tr>
                ...
                <td bgcolor="#35415B"><div align="center"><?php echo $row_Requests['request_date']; ?></div></td>
                <td bgcolor="#35415B"><div align="center"><?php echo $row_Requests['request_time']; ?></div></td>
                <td bgcolor="#35415B"><div align="center"><?php echo $row_Requests['request_type']; ?></div></td>
