...
$query_Recordset1 = "SELECT * FROM pgc_pilot_signoffs A, pgc_members B WHERE (A.status = 'Expired-A' OR A.status = 'Expired-B') AND (A.pilot_name = B.NAME) AND (B.active = 'YES') ORDER BY A.pilot_name ASC, A.status ASC";
...
<title>PGC Data Portal - Pilot Signoff List - Expired</title>
<style type="text/css">
<!--
body,td,th {
...
<body>
<table width="900" align="center" cellpadding="2" cellspacing="1" bordercolor="#000033" bgcolor="#666666">
  <tr>
    <td><div align="center"><span class="style1">PILOT DATA PORTAL </span></div></td>
  </tr>
  <tr>
    <td height="476"><table width="97%" height="456" align="center" cellpadding="2" cellspacing="2" bordercolor="#005B5B" bgcolor="#4F5359">
      <tr>
        <td height="36" bgcolor="#59111E"><div align="center">
              <table width="98%" cellspacing="1" cellpadding="1">
                    <tr>
                          <td width="18%" align="center" bgcolor="#6C0000" class="style14"><a href="pgc_expired_critical-2_xls.php" class="style14"><span class="style12">EXCEL REPORT</span></a></td>
                          <td width="66%" align="center"><span class="style11">EXPIRED SIGNOFFS -  NOFLY AND CRITICAL - PILOT SORT</span></td>
                          <td width="16%" align="center" bgcolor="#6C0000"><strong class="style11"><a href="../PGC_OPS/pgc_portal_menu.php" class="style16"><span class="style15"><span class="style11"><span class="style12">BACK TO MAIN</span></span></span></a></strong></td>
                    </tr>
              </table>
        </div></td>
      </tr>
      <tr>
        <td height="373" align="center" valign="top"><table cellpadding="2" cellspacing="1" bordercolor="#530000" bgcolor="#4B6365">
            <tr>
              <td width="140" bgcolor="#0C3E43" class="style16 style14"><div align="center"><em>Pilot Name </em></div></td>
              <td width="220" bgcolor="#0C3E43" class="style16 style14"><div align="center"><em>Signoff Type </em></div></td>
              <td width="99" bgcolor="#0C3E43" class="style16 style14"><div align="center"><em>Date</em></div></td>
              <td width="129" bgcolor="#0C3E43" class="style16 style14"><div align="center"><em>Instructor</em></div></td>
            ...
            <?php do { ?>
              <tr>
                <td height="21" bgcolor="#212545"><?php echo $row_Recordset1['pilot_name']; ?></td>
                <td bgcolor="#212545"><?php echo $row_Recordset1['signoff_type']; ?></td>
                <td bgcolor="#212545"><?php echo $row_Recordset1['signoff_date']; ?></td>
                <td bgcolor="#212545"><?php echo $row_Recordset1['instructor']; ?></td>
                <td bgcolor="#212545"><?php echo $row_Recordset1['expire_date']; ?></td>
              ...
              ?>
              <td width="60" bgcolor="#212545" td><div align="center"><span class="style19"><?php echo $row_Recordset1['status']; ?></span></div></td>
