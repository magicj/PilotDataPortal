...
$delete_Recordset1 = "DELETE FROM pgc_doc_category_master WHERE rec_deleted = 'YES'";
...
if ((isset($_POST["MM_insert"])) && ($_POST["doc_category"] <> '') && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertGoTo = "pgc_doc_cat_master_create.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_PGC, $PGC);
$query_Recordset1 = "SELECT * FROM pgc_doc_category_master";
...
mysql_select_db($database_PGC, $PGC);
$query_Recordset1 = "SELECT * FROM pgc_doc_category_master ORDER BY doc_category ASC";
$query_limit_Recordset1 = sprintf("%s LIMIT %d, %d", $query_Recordset1, $startRow_Recordset1, $maxRows_Recordset1);
$Recordset1 = mysql_query($query_limit_Recordset1, $PGC) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
...
<table width="939" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#666666">
    <tr>
      <td width="900" height="5" align="center" bgcolor="#387272"><p class="JobBanner">PGC DOCUMENT LIBRARY -  DOCUMENT CATEGORY CREATE</p></td>
  </tr>
    <tr>
      <td height="481" align="center" valign="top"><form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
          <table width="468" align="center">
                <tr valign="baseline" class="JobHeader">
                    <td width="165" height="49" align="right" valign="middle" nowrap="nowrap">New Document Category Name:</td>
                    <td width="256" valign="middle"><input type="text" name="doc_category" value="" size="32" /></td>
                </tr>
                <tr valign="baseline">
                    <td height="39" colspan="2" align="center" valign="middle" nowrap="nowrap"><input type="submit" value="Create Category"  /></td>
          ...
          <table width="80%" border="0" cellpadding="2" cellspacing="2" class="JobGrid">
            ...
            <tr>
                <td align="center" bgcolor="#314064"><span class="JobHeader">Document Category</span></td>
            ...
            <?php do { ?>
            <tr>
                <td align="center" bgcolor="#44598A"><a href="pgc_doc_cat_master_edit.php?rec_key=<?php echo $row_Recordset1['rec_key']; ?>"><?php echo $row_Recordset1['doc_category']; ?></a></td>
