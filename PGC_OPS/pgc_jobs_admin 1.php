...
$_SESSION['last_adminjob_query'] =  $_SERVER['QUERY_STRING'];
...
mysql_select_db($database_PGC, $PGC);
$query_Recordset1 = "SELECT job_key, post_date, post_id, job_sponsor, job_sponsor_email, job_leader, job_leader_email,  job_name, job_description,job_materials, job_volunteers_required, job_volunteers, job_volunteers_email, job_comments, job_status, job_completed FROM pgc_jobs ORDER by job_key DESC";
...
<table width="1200" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#666666">
    <tr>
        <td bgcolor="#69011C"><div align="center" class="style38"><span class="JobBanner">SPECIAL PROJECTS - ADMIN VIEW</span></div></td>
    </tr>
    <tr>
      <td height="481" align="center"><table width="100%" height="447" align="center" cellpadding="2" cellspacing="2" bordercolor="#005B5B" bgcolor="#4F5359">
            ...
            <tr>
              <td height="373" colspan="5" align="center" valign="top"><table width="90%" cellspacing="1" cellpadding="4">
                <tr>
                    <td width="27%">&nbsp;</td>
                    <td width="46%" align="center"><span class="JobHeader">Click on ID to EDIT Project Record</span></td>
                    <td width="27%"><span class="JobHeader"><a href="pgc_jobs_enter.php"><img src="Graphics/NewSq.png" alt="New" width="130" height="30" border="0" /></a></span></td>
                  </tr>
                </table>
                <table width="98%" align="center" cellpadding="3" cellspacing="2" bgcolor="#330066" class="JobGrid">
                    ...
                    <?php do { ?>
                      <tr class="JobLine">
                        <td width="10" align="center" bgcolor="#004879"><a href="pgc_jobs_modify.php?job_id=<?php echo $row_Recordset1['job_key']; ?>"><?php echo $row_Recordset1['job_key']; ?></a></td>
       ...
       <a href="pgc_portal_menu.php" class="JobHeader">PDP MAINTENANCE MENU</a></td>
    </tr>
</table>
<p>&nbsp;</p>
<p>&nbsp;</p>
