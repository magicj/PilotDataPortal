            ...
            <td height="398" bgcolor="#666666"><table width="95%" height="344" align="center" cellpadding="4" cellspacing="3" bordercolor="#005B5B" bgcolor="#005B5B">
                        <tr>
                          <td width="1562" height="23" valign="top" bgcolor="#0A335C"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="15%">&nbsp;</td>
                              <td width="7%">&nbsp;</td>
                              <td width="56%" class="style47"><div align="center" class="style53">PGC EQUIPMENT STATUS &amp; CAPTAINS</div></td>
                              <td width="16%">&nbsp;</td>
                              <td width="6%">&nbsp;</td>
                            </tr>
                          </table></td>
                        ...
                        <tr>
                          <td height="277" align="center" valign="top" bgcolor="#0A335C"><p>&nbsp;</p>
                            ...
                            <table width="85%" cellpadding="4" cellspacing="3" bgcolor="#A2B3B3">
                              <tr>
                                <td width="407" bgcolor="#35415B" class="style17 style45"><div align="center">EQUIPMENT</div></td>
                                <td bgcolor="#35415B" class="style17 style45"><div align="center">SHIP CAPTAIN </div></td>
                                <td width="362" bgcolor="#35415B" class="style17 style45"><div align="center">STATUS</div></td>
                              </tr>
                              <?php do { ?>
                                <tr>
                                  <td bgcolor="#48597B"><div align="left" class="style47"><?php echo $row_Recordset1['metrics_equipment']; ?></div></td>
                                  <td width="252" bgcolor="#48597B" class="style50"><?php echo $row_Recordset1['ship_captain']; ?></td>
