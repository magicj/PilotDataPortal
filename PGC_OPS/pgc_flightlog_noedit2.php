...
$query_Flightlog = sprintf("SELECT * FROM pgc_flightsheet WHERE Pilot1 <> '' AND  `Date` = %s ORDER BY `Key` DESC", GetSQLValueString($colname_Flightlog, "date"));
...
<body>
<table width="80%" align="center" cellpadding="2" cellspacing="2" bordercolor="#000033" bgcolor="#666666">
    <tr>
        <td><div align="center">
            <table width="100%">
                <tr>
                  ...
                  <td width="9%"><div align="center"></div></td>
                    <td width="59%"><div align="center"><span class="style1">PGC DATA PORTAL - FLIGHT SHEET for <?php echo $_SESSION['$Logdate'] ?></span></div></td>
    ...
    <tr>
        <td height="481"><table width="98%" height="447" align="center" cellpadding="2" cellspacing="2" bordercolor="#005B5B" bgcolor="#4F5359">
...
-->
            ...
            <tr>
                <td height="28"><div align="center"><strong class="style3"><a href="../pgc_test.php" class="style16">Back to Main Page</a></strong></div></td>
            </tr>
        </table></td>
    </tr>
</table>
